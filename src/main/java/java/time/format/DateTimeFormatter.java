...
public final class DateTimeFormatter {
    ...
    static {
        ...
        RFC_1123_DATE_TIME = new DateTimeFormatterBuilder()
                ...
                .optionalEnd()
                .appendLiteral(' ')
                .appendOffset("+HHMM", "GMT")  .toFormatter(ResolverStyle.SMART, IsoChronology.INSTANCE);
    }
    ...
    private DateTimeParseContext parseUnresolved0(CharSequence text, ParsePosition position) {
        ...
        if (pos < 0) {
            position.setErrorIndex(~pos);  return null;
        }
        position.setIndex(pos);  return context;
    }
    ...
    @SuppressWarnings("serial")  static class ClassicFormat extends Format {
