...
public final class LocalTime
    ...
    public static LocalTime now(Clock clock) {
        ...
        long localSecond = now.getEpochSecond() + offset.getTotalSeconds();  int secsOfDay = (int) Math.floorMod(localSecond, SECONDS_PER_DAY);
    ...
    public long until(Temporal endExclusive, TemporalUnit unit) {
        ...
        if (unit instanceof ChronoUnit) {
            long nanosUntil = end.toNanoOfDay() - toNanoOfDay();  switch ((ChronoUnit) unit) {
