...
public final class ZonedDateTime
    ...
    public static ZonedDateTime now(Clock clock) {
        ...
        final Instant now = clock.instant();  return ofInstant(now, clock.getZone());
    }
    ...
    private static ZonedDateTime create(long epochSecond, int nanoOfSecond, ZoneId zone) {
        ZoneRules rules = zone.getRules();
        Instant instant = Instant.ofEpochSecond(epochSecond, nanoOfSecond);  ZoneOffset offset = rules.getOffset(instant);
    ...
    @Override  public LocalDateTime toLocalDateTime() {
        return dateTime;
    }

    @Override  public LocalDate toLocalDate() {
    ...
    @Override  public LocalTime toLocalTime() {
