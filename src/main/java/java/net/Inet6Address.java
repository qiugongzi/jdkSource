...
class Inet6Address extends InetAddress {
    ...
    private transient int cached_scope_id;  private class Inet6AddressHolder {
        ...
        int scope_id;  boolean scope_id_set;  NetworkInterface scope_ifname;  boolean scope_ifname_set; void setAddr(byte addr[]) {
            if (addr.length == INADDRSZ) { System.arraycopy(addr, 0, ipaddress, 0, INADDRSZ);
            }
        }
        ...
        throws UnknownHostException
    {
        ...
        if (addr.length == INADDRSZ) { family = IPv6;
        }
