    ...
    implements Comparable<Charset>
{
    ...
    static boolean atBugLevel(String bl) {              String level = bugLevel;
        if (level == null) {
    ...
    private static volatile Object[] cache1 = null; private static volatile Object[] cache2 = null; private static void cache(String charsetName, Charset cs) {
        cache2 = cache1;
    ...
    private final String name;          private final String[] aliases;     private Set<String> aliasSet = null;
