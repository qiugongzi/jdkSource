    ...
    extends CharBuffer
{
    ...
    HeapCharBuffer(int cap, int lim) {            super(-1, 0, lim, cap, new char[cap], 0);
    ...
    HeapCharBuffer(char[] buf, int off, int len) { super(-1, off, off + len, buf.length, buf, 0);
    ...
    String toString(int start, int end) {               try {
