    ...
    implements DirectBuffer
{
    ...
    DirectByteBuffer(DirectBuffer db,         int mark, int pos, int lim, int cap,
                               int off)
    {
    ...
    byte _get(int i) {                          return unsafe.getByte(address + i);
    }

    void _put(int i, byte b) {                  unsafe.putByte(address + i, b);
