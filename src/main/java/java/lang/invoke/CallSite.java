...
public class CallSite {
    ...
    MethodHandle target;    CallSite(MethodType type) {
    ...
    void checkTargetChange(MethodHandle oldTarget, MethodHandle newTarget) {
        ...
        MethodType newType = newTarget.type();  if (!newType.equals(oldType))
        ...
        try {
            ...
            if (info == null) {
                ...
                case 6:
                    ...
                    break;
                default:
                    final int NON_SPREAD_ARG_COUNT = 3;  if (NON_SPREAD_ARG_COUNT + argv.length > MethodType.MAX_MH_ARITY)
