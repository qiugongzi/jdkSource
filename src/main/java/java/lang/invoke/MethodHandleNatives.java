...
class MethodHandleNatives {
    ...
    private MethodHandleNatives() { } static native void init(MemberName self, Object ref);
    static native void expand(MemberName self);
    static native MemberName resolve(MemberName self, Class<?> caller) throws LinkageError, ClassNotFoundException;
    static native int getMembers(Class<?> defc, String matchName, String matchSig,
            int matchFlags, Class<?> caller, int skip, MemberName[] results);

    static native long objectFieldOffset(MemberName self);  static native long staticFieldOffset(MemberName self);  static native Object staticFieldBase(MemberName self);  static native Object getMemberVMInfo(MemberName self);  static native int getConstant(int which);
    ...
    static class Constants {
        Constants() { } static final int GC_COUNT_GWT = 4,
                GC_LAMBDA_SUPPORT = 5;

        static final int
                MN_IS_METHOD           = 0x00010000, MN_IS_CONSTRUCTOR      = 0x00020000, MN_IS_FIELD            = 0x00040000, MN_IS_TYPE             = 0x00080000, MN_CALLER_SENSITIVE    = 0x00100000, MN_REFERENCE_KIND_SHIFT = 24, MN_REFERENCE_KIND_MASK = 0x0F000000 >> MN_REFERENCE_KIND_SHIFT,
        ...
        static final byte
            ...
            CONSTANT_LIMIT               = 19;   static final char
            ACC_PUBLIC                 = 0x0001,
            ACC_PRIVATE                = 0x0002,
    ...
    static boolean isCallerSensitive(MemberName mem) {
        if (!mem.isInvocable())  return false;  return mem.isCallerSensitive() || canBeCalledVirtual(mem);
    }
