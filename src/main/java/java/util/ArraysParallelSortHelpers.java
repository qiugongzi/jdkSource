    ...
    static final class FJObject {
        static final class Sorter<T> extends CountedCompleter<Void> {
            ...
            public final void compute() {
                ...
                T[] a = this.a, w = this.w; int b = this.base, n = this.size, wb = this.wbase, g = this.gran;
                while (n > g) {
                    int h = n >>> 1, q = h >>> 1, u = h + q; Relay fc = new Relay(new Merger<T>(s, w, a, wb, h,
                                                       wb+h, n-h, b, g, c));
        ...
        static final class Merger<T> extends CountedCompleter<Void> {
            static final long serialVersionUID = 2446542900576103244L;
            final T[] a, w; final int lbase, lsize, rbase, rsize, wbase, gran;
            Comparator<? super T> comparator;
            ...
            public final void compute() {
                Comparator<? super T> c = this.comparator;
                T[] a = this.a, w = this.w; int lb = this.lbase, ln = this.lsize, rb = this.rbase,
                    rn = this.rsize, k = this.wbase, g = this.gran;
                if (a == null || w == null || lb < 0 || rb < 0 || k < 0 ||
                    c == null)
                    throw new IllegalStateException(); for (int lh, rh;;) {  if (ln >= rn) {
                        if (ln <= g)
                            break;
                        rh = rn;
                ...
                int lf = lb + ln, rf = rb + rn; while (lb < lf && rb < rf) {
                    T t, al, ar;
        ...
        static final class Sorter extends CountedCompleter<Void> {
            ...
            public final void compute() {
                CountedCompleter<?> s = this;
                byte[] a = this.a, w = this.w; int b = this.base, n = this.size, wb = this.wbase, g = this.gran;
                while (n > g) {
                    int h = n >>> 1, q = h >>> 1, u = h + q; Relay fc = new Relay(new Merger(s, w, a, wb, h,
                                                    wb+h, n-h, b, g));
        ...
        static final class Merger extends CountedCompleter<Void> {
            static final long serialVersionUID = 2446542900576103244L;
            final byte[] a, w; final int lbase, lsize, rbase, rsize, wbase, gran;
            ...
            public final void compute() {
                byte[] a = this.a, w = this.w; int lb = this.lbase, ln = this.lsize, rb = this.rbase,
                    rn = this.rsize, k = this.wbase, g = this.gran;
                if (a == null || w == null || lb < 0 || rb < 0 || k < 0)
                    throw new IllegalStateException(); for (int lh, rh;;) {  if (ln >= rn) {
                        if (ln <= g)
        ...
        static final class Sorter extends CountedCompleter<Void> {
            ...
            public final void compute() {
                CountedCompleter<?> s = this;
                char[] a = this.a, w = this.w; int b = this.base, n = this.size, wb = this.wbase, g = this.gran;
                while (n > g) {
                    int h = n >>> 1, q = h >>> 1, u = h + q; Relay fc = new Relay(new Merger(s, w, a, wb, h,
                                                    wb+h, n-h, b, g));
                    Relay rc = new Relay(new Merger(fc, a, w, b+h, q,
        ...
        static final class Merger extends CountedCompleter<Void> {
            static final long serialVersionUID = 2446542900576103244L;
            final char[] a, w; final int lbase, lsize, rbase, rsize, wbase, gran;
            ...
            public final void compute() {
                char[] a = this.a, w = this.w; int lb = this.lbase, ln = this.lsize, rb = this.rbase,
                    rn = this.rsize, k = this.wbase, g = this.gran;
                if (a == null || w == null || lb < 0 || rb < 0 || k < 0)
                    throw new IllegalStateException(); for (int lh, rh;;) {  if (ln >= rn) {
                        if (ln <= g)
        ...
        static final class Sorter extends CountedCompleter<Void> {
            ...
            public final void compute() {
                CountedCompleter<?> s = this;
                short[] a = this.a, w = this.w; int b = this.base, n = this.size, wb = this.wbase, g = this.gran;
                while (n > g) {
                    int h = n >>> 1, q = h >>> 1, u = h + q; Relay fc = new Relay(new Merger(s, w, a, wb, h,
                                                    wb+h, n-h, b, g));
                    Relay rc = new Relay(new Merger(fc, a, w, b+h, q,
        ...
        static final class Merger extends CountedCompleter<Void> {
            static final long serialVersionUID = 2446542900576103244L;
            final short[] a, w; final int lbase, lsize, rbase, rsize, wbase, gran;
            ...
            public final void compute() {
                short[] a = this.a, w = this.w; int lb = this.lbase, ln = this.lsize, rb = this.rbase,
                    rn = this.rsize, k = this.wbase, g = this.gran;
                if (a == null || w == null || lb < 0 || rb < 0 || k < 0)
                    throw new IllegalStateException(); for (int lh, rh;;) {  if (ln >= rn) {
                        if (ln <= g)
        ...
        static final class Sorter extends CountedCompleter<Void> {
            ...
            public final void compute() {
                CountedCompleter<?> s = this;
                int[] a = this.a, w = this.w; int b = this.base, n = this.size, wb = this.wbase, g = this.gran;
                while (n > g) {
                    int h = n >>> 1, q = h >>> 1, u = h + q; Relay fc = new Relay(new Merger(s, w, a, wb, h,
                                                    wb+h, n-h, b, g));
                    Relay rc = new Relay(new Merger(fc, a, w, b+h, q,
        ...
        static final class Merger extends CountedCompleter<Void> {
            static final long serialVersionUID = 2446542900576103244L;
            final int[] a, w; final int lbase, lsize, rbase, rsize, wbase, gran;
            ...
            public final void compute() {
                int[] a = this.a, w = this.w; int lb = this.lbase, ln = this.lsize, rb = this.rbase,
                    rn = this.rsize, k = this.wbase, g = this.gran;
                if (a == null || w == null || lb < 0 || rb < 0 || k < 0)
                    throw new IllegalStateException(); for (int lh, rh;;) {  if (ln >= rn) {
                        if (ln <= g)
        ...
        static final class Sorter extends CountedCompleter<Void> {
            ...
            public final void compute() {
                CountedCompleter<?> s = this;
                long[] a = this.a, w = this.w; int b = this.base, n = this.size, wb = this.wbase, g = this.gran;
                while (n > g) {
                    int h = n >>> 1, q = h >>> 1, u = h + q; Relay fc = new Relay(new Merger(s, w, a, wb, h,
                                                    wb+h, n-h, b, g));
                    Relay rc = new Relay(new Merger(fc, a, w, b+h, q,
        ...
        static final class Merger extends CountedCompleter<Void> {
            static final long serialVersionUID = 2446542900576103244L;
            final long[] a, w; final int lbase, lsize, rbase, rsize, wbase, gran;
            ...
            public final void compute() {
                long[] a = this.a, w = this.w; int lb = this.lbase, ln = this.lsize, rb = this.rbase,
                    rn = this.rsize, k = this.wbase, g = this.gran;
                if (a == null || w == null || lb < 0 || rb < 0 || k < 0)
                    throw new IllegalStateException(); for (int lh, rh;;) {  if (ln >= rn) {
                        if (ln <= g)
        ...
        static final class Sorter extends CountedCompleter<Void> {
            ...
            public final void compute() {
                CountedCompleter<?> s = this;
                float[] a = this.a, w = this.w; int b = this.base, n = this.size, wb = this.wbase, g = this.gran;
                while (n > g) {
                    int h = n >>> 1, q = h >>> 1, u = h + q; Relay fc = new Relay(new Merger(s, w, a, wb, h,
                                                    wb+h, n-h, b, g));
                    Relay rc = new Relay(new Merger(fc, a, w, b+h, q,
        ...
        static final class Merger extends CountedCompleter<Void> {
            static final long serialVersionUID = 2446542900576103244L;
            final float[] a, w; final int lbase, lsize, rbase, rsize, wbase, gran;
            ...
            public final void compute() {
                float[] a = this.a, w = this.w; int lb = this.lbase, ln = this.lsize, rb = this.rbase,
                    rn = this.rsize, k = this.wbase, g = this.gran;
                if (a == null || w == null || lb < 0 || rb < 0 || k < 0)
                    throw new IllegalStateException(); for (int lh, rh;;) {  if (ln >= rn) {
                        if (ln <= g)
        ...
        static final class Sorter extends CountedCompleter<Void> {
            ...
            public final void compute() {
                CountedCompleter<?> s = this;
                double[] a = this.a, w = this.w; int b = this.base, n = this.size, wb = this.wbase, g = this.gran;
                while (n > g) {
                    int h = n >>> 1, q = h >>> 1, u = h + q; Relay fc = new Relay(new Merger(s, w, a, wb, h,
                                                    wb+h, n-h, b, g));
                    Relay rc = new Relay(new Merger(fc, a, w, b+h, q,
        ...
        static final class Merger extends CountedCompleter<Void> {
            static final long serialVersionUID = 2446542900576103244L;
            final double[] a, w; final int lbase, lsize, rbase, rsize, wbase, gran;
            ...
            public final void compute() {
                double[] a = this.a, w = this.w; int lb = this.lbase, ln = this.lsize, rb = this.rbase,
                    rn = this.rsize, k = this.wbase, g = this.gran;
                if (a == null || w == null || lb < 0 || rb < 0 || k < 0)
                    throw new IllegalStateException(); for (int lh, rh;;) {  if (ln >= rn) {
                        if (ln <= g)
