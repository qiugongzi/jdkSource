...
public class ArrayBlockingQueue<E> extends AbstractQueue<E>
    ...
    public E peek() {
        ...
        lock.lock();
        try {
            return itemAt(takeIndex); } finally {
            lock.unlock();
        }
    }
    ...
    class Itrs {
        ...
        void doSomeSweeping(boolean tryHarder) {
            ...
            boolean passedGo;   if (sweeper == null) {
                o = null;
                p = head;
                passedGo = true;
            } else {
            ...
            for (; probes > 0; probes--) {
                ...
                if (it == null || it.isDetached()) {
                    probes = LONG_SWEEP_PROBES; p.clear();
                    p.next = null;
                    if (o == null) {
                        head = next;
                        if (next == null) {
    ...
    private class Itr implements Iterator<E> {
            ...
            try {
                if (count == 0) {
                    ...
                    if (itrs == null) {
                        ...
                        itrs.register(this); itrs.doSomeSweeping(false);
                    }
        ...
        private void noNext() {
            ...
            try {
                if (!isDetached()) {
                    incorporateDequeues(); if (lastRet >= 0) {
        ...
        public void remove() {
            ...
            try {
                if (!isDetached())
                    incorporateDequeues(); final int lastRet = this.lastRet;
                this.lastRet = NONE;
                if (lastRet >= 0) {
                    if (!isDetached())
                        removeAt(lastRet);
