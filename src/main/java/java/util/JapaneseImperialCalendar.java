...
class JapaneseImperialCalendar extends Calendar {
    ...
    static final int MIN_VALUES[] = {
        0,              -292275055,     JANUARY,        1,              0,              1,              1,              SUNDAY,         1,              AM,             0,              0,              0,              0,              0,              -13*ONE_HOUR,   0               };
    static final int LEAST_MAX_VALUES[] = {
        0,              0,              JANUARY,        0,              4,              28,             0,              SATURDAY,       4,              PM,             11,             23,             59,             59,             999,            14*ONE_HOUR,    20*ONE_MINUTE   };
    static final int MAX_VALUES[] = {
        0,              292278994,      DECEMBER,       53,             6,              31,             366,            SATURDAY,       6,              PM,             11,             23,             59,             59,             999,            14*ONE_HOUR,    2*ONE_HOUR      };
    ...
    static {
        ...
        LEAST_MAX_VALUES[YEAR] = year; LEAST_MAX_VALUES[DAY_OF_YEAR] = dayOfYear;
    }
    ...
    public void roll(int field, int amount) {
        ...
        case WEEK_OF_YEAR:
            {
                ...
                set(DAY_OF_WEEK, internalGet(DAY_OF_WEEK)); int woy = internalGet(WEEK_OF_YEAR);
        ...
        case WEEK_OF_MONTH:
            {
                ...
                long fd = cachedFixedDate;
                long month1;     int monthLength; if (isTransitionYear) {
        ...
        case DAY_OF_WEEK_IN_MONTH:
            {
                min = 1; if (!isTransitionYear(jdate.getNormalizedYear())) {
    ...
    private int computeFields(int fieldMask, int tzMask) {
        ...
        int month =  jdate.getMonth() - 1; int dayOfMonth = jdate.getDayOfMonth();
