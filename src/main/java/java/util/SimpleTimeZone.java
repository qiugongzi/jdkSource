...
public class SimpleTimeZone extends TimeZone {
                         ...
                         int millis)
    {
        ...
        long time = cal.getTime(cdate); time += millis - rawOffset; if (time < GregorianCalendar.DEFAULT_GREGORIAN_CUTOVER) {
    ...
    private boolean useDaylight=false; private static final int millisPerHour = 60*60*1000;
    ...
    private static final int DOM_MODE          = 1; private static final int DOW_IN_MONTH_MODE = 2; private static final int DOW_GE_DOM_MODE   = 3; private static final int DOW_LE_DOM_MODE   = 4; public static final int WALL_TIME = 0; public static final int STANDARD_TIME = 1;
