...
public class WeakHashMap<K,V>
    ...
    static class WeakHashMapSpliterator<K,V> {
        ...
        WeakHashMap.Entry<K,V> current; int index;             int fence;             int est;               int expectedModCount;  WeakHashMapSpliterator(WeakHashMap<K,V> m, int origin,
                               int fence, int est,
