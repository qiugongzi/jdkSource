...
public class LogManager {
    ...
    class LoggerContext {
        ...
        final Logger getGlobalLogger() {
            @SuppressWarnings("deprecated") final Logger global = Logger.global;
            return global;
        }
    ...
    final class LoggerWeakRef extends WeakReference<Logger> {
        private String                name;       private LogNode               node;       private WeakReference<Logger> parentRef;  private boolean disposed = false;         LoggerWeakRef(Logger logger) {
