...
public final class Formatter implements Closeable, Flushable {
    ...
    public Formatter format(Locale l, String format, Object ... args) {
        ...
        for (int i = 0; i < fsa.length; i++) {
            ...
            try {
                switch (index) {
                case -2:  fs.print(null, l);
                    break;
                case -1:  if (last < 0 || (args != null && last > args.length - 1))
    ...
    private class FormatSpecifier implements FormatString {
            ...
            throws IOException
        {
            ...
            switch (c) {
            case DateTime.HOUR_OF_DAY_0: case DateTime.HOUR_0:        case DateTime.HOUR_OF_DAY:   case DateTime.HOUR:        { int i = t.get(Calendar.HOUR_OF_DAY);
            ...
            case DateTime.MINUTE:      { int i = t.get(Calendar.MINUTE);
                Flags flags = Flags.ZERO_PAD;
                sb.append(localizedMagnitude(null, i, flags, 2, l));
                break;
            }
            case DateTime.NANOSECOND:  { int i = t.get(Calendar.MILLISECOND) * 1000000;
                Flags flags = Flags.ZERO_PAD;
                sb.append(localizedMagnitude(null, i, flags, 9, l));
                break;
            }
            case DateTime.MILLISECOND: { int i = t.get(Calendar.MILLISECOND);
                Flags flags = Flags.ZERO_PAD;
                sb.append(localizedMagnitude(null, i, flags, 3, l));
                break;
            }
            case DateTime.MILLISECOND_SINCE_EPOCH: { long i = t.getTimeInMillis();
                Flags flags = Flags.NONE;
                sb.append(localizedMagnitude(null, i, flags, width, l));
                break;
            }
            case DateTime.AM_PM:       { String[] ampm = { "AM", "PM" };
            ...
            case DateTime.SECONDS_SINCE_EPOCH: { long i = t.getTimeInMillis() / 1000;
                Flags flags = Flags.NONE;
                sb.append(localizedMagnitude(null, i, flags, width, l));
                break;
            }
            case DateTime.SECOND:      { int i = t.get(Calendar.SECOND);
                Flags flags = Flags.ZERO_PAD;
                sb.append(localizedMagnitude(null, i, flags, 2, l));
                break;
            }
            case DateTime.ZONE_NUMERIC: { int i = t.get(Calendar.ZONE_OFFSET) + t.get(Calendar.DST_OFFSET);
                boolean neg = i < 0;
                sb.append(neg ? '-' : '+');
                if (neg)
                    i = -i;
            ...
            case DateTime.ZONE:        { TimeZone tz = t.getTimeZone();
            ...
            case DateTime.NAME_OF_DAY_ABBREV:     case DateTime.NAME_OF_DAY:          { int i = t.get(Calendar.DAY_OF_WEEK);
            ...
            case DateTime.NAME_OF_MONTH_ABBREV:   case DateTime.NAME_OF_MONTH_ABBREV_X: case DateTime.NAME_OF_MONTH:        { int i = t.get(Calendar.MONTH);
                Locale lt = ((l == null) ? Locale.US : l);
                DateFormatSymbols dfs = DateFormatSymbols.getInstance(lt);
            ...
            case DateTime.CENTURY:                case DateTime.YEAR_2:                 case DateTime.YEAR_4:               { int i = t.get(Calendar.YEAR);
                int size = 2;
                switch (c) {
            ...
            case DateTime.DAY_OF_MONTH_0:         case DateTime.DAY_OF_MONTH:         { int i = t.get(Calendar.DATE);
            ...
            case DateTime.DAY_OF_YEAR:          { int i = t.get(Calendar.DAY_OF_YEAR);
                Flags flags = Flags.ZERO_PAD;
                sb.append(localizedMagnitude(null, i, flags, 3, l));
                break;
            }
            case DateTime.MONTH:                { int i = t.get(Calendar.MONTH) + 1;
                Flags flags = Flags.ZERO_PAD;
                sb.append(localizedMagnitude(null, i, flags, 2, l));
                break;
            }

            case DateTime.TIME:         case DateTime.TIME_24_HOUR:    { char sep = ':';
            ...
            case DateTime.TIME_12_HOUR:    { char sep = ':';
            ...
            case DateTime.DATE_TIME:    { char sep = ' ';
            ...
            case DateTime.DATE:            { char sep = '/';
                print(sb, t, DateTime.MONTH, l).append(sep);
                print(sb, t, DateTime.DAY_OF_MONTH_0, l).append(sep);
                print(sb, t, DateTime.YEAR_2, l);
                break;
            }
            case DateTime.ISO_STANDARD_DATE: { char sep = '-';
        ...
        private Appendable print(StringBuilder sb, TemporalAccessor t, char c,
            ...
            try {
                switch (c) {
                case DateTime.HOUR_OF_DAY_0: {  int i = t.get(ChronoField.HOUR_OF_DAY);
                    sb.append(localizedMagnitude(null, i, Flags.ZERO_PAD, 2, l));
                    break;
                }
                case DateTime.HOUR_OF_DAY: {   int i = t.get(ChronoField.HOUR_OF_DAY);
                    sb.append(localizedMagnitude(null, i, Flags.NONE, 2, l));
                    break;
                }
                case DateTime.HOUR_0:      {  int i = t.get(ChronoField.CLOCK_HOUR_OF_AMPM);
                    sb.append(localizedMagnitude(null, i, Flags.ZERO_PAD, 2, l));
                    break;
                }
                case DateTime.HOUR:        { int i = t.get(ChronoField.CLOCK_HOUR_OF_AMPM);
                    sb.append(localizedMagnitude(null, i, Flags.NONE, 2, l));
                    break;
                }
                case DateTime.MINUTE:      { int i = t.get(ChronoField.MINUTE_OF_HOUR);
                    Flags flags = Flags.ZERO_PAD;
                    sb.append(localizedMagnitude(null, i, flags, 2, l));
                    break;
                }
                case DateTime.NANOSECOND:  { int i = t.get(ChronoField.MILLI_OF_SECOND) * 1000000;
                    Flags flags = Flags.ZERO_PAD;
                    sb.append(localizedMagnitude(null, i, flags, 9, l));
                    break;
                }
                case DateTime.MILLISECOND: { int i = t.get(ChronoField.MILLI_OF_SECOND);
                    Flags flags = Flags.ZERO_PAD;
                    sb.append(localizedMagnitude(null, i, flags, 3, l));
                    break;
                }
                case DateTime.MILLISECOND_SINCE_EPOCH: { long i = t.getLong(ChronoField.INSTANT_SECONDS) * 1000L +
                ...
                case DateTime.SECONDS_SINCE_EPOCH: { long i = t.getLong(ChronoField.INSTANT_SECONDS);
                    Flags flags = Flags.NONE;
                    sb.append(localizedMagnitude(null, i, flags, width, l));
                    break;
                }
                case DateTime.SECOND:      { int i = t.get(ChronoField.SECOND_OF_MINUTE);
                    Flags flags = Flags.ZERO_PAD;
                    sb.append(localizedMagnitude(null, i, flags, 2, l));
                    break;
                }
                case DateTime.ZONE_NUMERIC: { int i = t.get(ChronoField.OFFSET_SECONDS);
                    boolean neg = i < 0;
                    sb.append(neg ? '-' : '+');
                    if (neg)
                        i = -i;
                ...
                case DateTime.ZONE:        { ZoneId zid = t.query(TemporalQueries.zone());
                    if (zid == null) {
                ...
                case DateTime.NAME_OF_DAY_ABBREV:     case DateTime.NAME_OF_DAY:          { int i = t.get(ChronoField.DAY_OF_WEEK) % 7 + 1;
                    Locale lt = ((l == null) ? Locale.US : l);
                    DateFormatSymbols dfs = DateFormatSymbols.getInstance(lt);
                    if (c == DateTime.NAME_OF_DAY)
                        sb.append(dfs.getWeekdays()[i]);
                ...
                case DateTime.NAME_OF_MONTH_ABBREV:   case DateTime.NAME_OF_MONTH_ABBREV_X: case DateTime.NAME_OF_MONTH:        { int i = t.get(ChronoField.MONTH_OF_YEAR) - 1;
                    Locale lt = ((l == null) ? Locale.US : l);
                    DateFormatSymbols dfs = DateFormatSymbols.getInstance(lt);
                    if (c == DateTime.NAME_OF_MONTH)
                        sb.append(dfs.getMonths()[i]);
                ...
                case DateTime.CENTURY:                case DateTime.YEAR_2:                 case DateTime.YEAR_4:               { int i = t.get(ChronoField.YEAR_OF_ERA);
                    int size = 2;
                    switch (c) {
                    case DateTime.CENTURY:
                        i /= 100;
                ...
                case DateTime.DAY_OF_MONTH_0:         case DateTime.DAY_OF_MONTH:         { int i = t.get(ChronoField.DAY_OF_MONTH);
                    Flags flags = (c == DateTime.DAY_OF_MONTH_0
                                   ? Flags.ZERO_PAD
                                   : Flags.NONE);
                    sb.append(localizedMagnitude(null, i, flags, 2, l));
                ...
                case DateTime.DAY_OF_YEAR:          { int i = t.get(ChronoField.DAY_OF_YEAR);
                    Flags flags = Flags.ZERO_PAD;
                    sb.append(localizedMagnitude(null, i, flags, 3, l));
                    break;
                }
                case DateTime.MONTH:                { int i = t.get(ChronoField.MONTH_OF_YEAR);
                    Flags flags = Flags.ZERO_PAD;
                    sb.append(localizedMagnitude(null, i, flags, 2, l));
                    break;
                }
    ...
    private static class Flags {
        ...
        static final Flags NONE          = new Flags(0);      static final Flags LEFT_JUSTIFY  = new Flags(1<<0);   static final Flags UPPERCASE     = new Flags(1<<1);   static final Flags ALTERNATE     = new Flags(1<<2);   static final Flags PLUS          = new Flags(1<<3);   static final Flags LEADING_SPACE = new Flags(1<<4);   static final Flags ZERO_PAD      = new Flags(1<<5);   static final Flags GROUP         = new Flags(1<<6);   static final Flags PARENTHESES   = new Flags(1<<7);   static final Flags PREVIOUS      = new Flags(1<<8);   private Flags(int f) {
            flags = f;
        }
    ...
    private static class DateTime {
        static final char HOUR_OF_DAY_0 = 'H'; static final char HOUR_0        = 'I'; static final char HOUR_OF_DAY   = 'k'; static final char HOUR          = 'l'; static final char MINUTE        = 'M'; static final char NANOSECOND    = 'N'; static final char MILLISECOND   = 'L'; static final char MILLISECOND_SINCE_EPOCH = 'Q'; static final char AM_PM         = 'p'; static final char SECONDS_SINCE_EPOCH = 's'; static final char SECOND        = 'S'; static final char TIME          = 'T'; static final char ZONE_NUMERIC  = 'z'; static final char ZONE          = 'Z'; static final char NAME_OF_DAY_ABBREV    = 'a'; static final char NAME_OF_DAY           = 'A'; static final char NAME_OF_MONTH_ABBREV  = 'b'; static final char NAME_OF_MONTH         = 'B'; static final char CENTURY               = 'C'; static final char DAY_OF_MONTH_0        = 'd'; static final char DAY_OF_MONTH          = 'e'; static final char NAME_OF_MONTH_ABBREV_X  = 'h'; static final char DAY_OF_YEAR           = 'j'; static final char MONTH                 = 'm'; static final char YEAR_2                = 'y'; static final char YEAR_4                = 'Y'; static final char TIME_12_HOUR  = 'r'; static final char TIME_24_HOUR  = 'R'; static final char DATE_TIME             = 'c';
                                            static final char DATE                  = 'D'; static final char ISO_STANDARD_DATE     = 'F'; static boolean isValid(char c) {
            switch (c) {
            case HOUR_OF_DAY_0:
            case HOUR_0:
            case HOUR_OF_DAY:
