...
public class MouseEvent extends InputEvent {
    ...
    public static final int MOUSE_PRESSED = 1 + MOUSE_FIRST; public static final int MOUSE_RELEASED = 2 + MOUSE_FIRST; public static final int MOUSE_MOVED = 3 + MOUSE_FIRST; public static final int MOUSE_ENTERED = 4 + MOUSE_FIRST; public static final int MOUSE_EXITED = 5 + MOUSE_FIRST; public static final int MOUSE_DRAGGED = 6 + MOUSE_FIRST; public static final int MOUSE_WHEEL = 7 + MOUSE_FIRST;
                      ...
                      int clickCount, boolean popupTrigger, int button)
    {
        ...
        if (button > BUTTON3) {
            ...
            if (getModifiersEx() != 0) { if (id == MouseEvent.MOUSE_RELEASED || id == MouseEvent.MOUSE_CLICKED){
