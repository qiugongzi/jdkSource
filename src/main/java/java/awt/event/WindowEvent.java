...
public class WindowEvent extends ComponentEvent {
    ...
    @Native public static final int WINDOW_OPENED       = WINDOW_FIRST; @Native public static final int WINDOW_CLOSING      = 1 + WINDOW_FIRST; @Native public static final int WINDOW_CLOSED       = 2 + WINDOW_FIRST;


    @Native public static final int WINDOW_ICONIFIED    = 3 + WINDOW_FIRST; @Native public static final int WINDOW_DEICONIFIED  = 4 + WINDOW_FIRST; @Native public static final int WINDOW_ACTIVATED    = 5 + WINDOW_FIRST;
