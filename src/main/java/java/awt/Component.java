                                           ...
                                           Serializable
{
    ...
    protected class FlipBufferStrategy extends BufferStrategy {
        ...
        protected int numBuffers; protected BufferCapabilities caps; protected Image drawBuffer; protected VolatileImage drawVBuffer; protected boolean validatedContents; int width;
        int height;
        ...
        protected BufferCapabilities caps; protected VolatileImage[] backBuffers; protected boolean validatedContents; protected int width;
    ...
    boolean dispatchMouseWheelToAncestor(MouseWheelEvent e) {
        ...
        synchronized (getTreeLock()) {
            ...
            if (anc != null && anc.eventEnabled(e)) {
                newMWE = new MouseWheelEvent(anc, e.getID(),
                                             e.getWhen(),
                                             e.getModifiers(),
                                             newX, newY, e.getXOnScreen(),
                                             e.getYOnScreen(),
                                             e.getClickCount(),
                                             e.isPopupTrigger(),
                                             e.getScrollType(),
