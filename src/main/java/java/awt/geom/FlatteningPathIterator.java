...
public class FlatteningPathIterator implements PathIterator {
    static final int GROW_SIZE = 24;    PathIterator src;                   double squareflat;                  int limit;                          double hold[] = new double[14];     double curx, cury;                  double movx, movy;                  int holdType;                       int holdEnd;                        int holdIndex;                      int levels[];                       int levelIndex;                     boolean done;                       public FlatteningPathIterator(PathIterator src, double flatness) {
