...
public final class NumericShaper implements java.io.Serializable {
    ...
    public static enum Range {
        ...
        private final int start, end;   private Range(int base, int start, int end) {
    ...
    private static final int NUM_KEYS = MONGOLIAN_KEY + 1; private static final int CONTEXTUAL_MASK = 1<<31;

    private static final char[] bases = {
        '\u0030' - '\u0030', '\u0660' - '\u0030', '\u06f0' - '\u0030', '\u0966' - '\u0030', '\u09e6' - '\u0030', '\u0a66' - '\u0030', '\u0ae6' - '\u0030', '\u0b66' - '\u0030', '\u0be6' - '\u0030', '\u0c66' - '\u0030', '\u0ce6' - '\u0030', '\u0d66' - '\u0030', '\u0e50' - '\u0030', '\u0ed0' - '\u0030', '\u0f20' - '\u0030', '\u1040' - '\u0030', '\u1369' - '\u0031', '\u17e0' - '\u0030', '\u1810' - '\u0030', };

    private static final char[] contexts = {
        '\u0000', '\u0300', '\u0600', '\u0780', '\u0600', '\u0780', '\u0900', '\u0980', '\u0980', '\u0a00', '\u0a00', '\u0a80', '\u0a80', '\u0b00', '\u0b00', '\u0b80', '\u0b80', '\u0c00', '\u0c00', '\u0c80', '\u0c80', '\u0d00', '\u0d00', '\u0d80', '\u0e00', '\u0e80', '\u0e80', '\u0f00', '\u0f00', '\u1000', '\u1000', '\u1080', '\u1200', '\u1380', '\u1780', '\u1800', '\u1800', '\u1900', '\uffff',
    };
    ...
    private NumericShaper(Range defaultContext, Set<Range> ranges) {
        ...
        rangeSet = EnumSet.copyOf(ranges); if (rangeSet.contains(Range.EASTERN_ARABIC)
    ...
    private synchronized void shapeContextually(char[] text, int start, int count, int ctxKey) {
        ...
        char minDigit = ctxKey == ETHIOPIC_KEY ? '1' : '0'; synchronized (NumericShaper.class) {
            for (int i = start, e = start + count; i < e; ++i) {
                char c = text[i];
                if (c >= minDigit && c <= '\u0039') {
                    text[i] = (char)(c + base);
