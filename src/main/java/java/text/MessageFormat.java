...
public class MessageFormat extends Format {
    ...
    @SuppressWarnings("fallthrough") public void applyPattern(String pattern) {
            ...
            for (int i = 0; i < pattern.length(); ++i) {
                ...
                if (part == SEG_RAW) {
                    ...
                    if (inQuote) {              segments[part].append(ch);
                        if (ch == '\'') {
                            inQuote = false;
                        }
                    } else {
    ...
    public Object[] parse(String source, ParsePosition pos) {
        ...
        for (int i = 0; i <= maxOffset; ++i) {
            ...
            if (formats[i] == null) {   int tempLength = (i != maxOffset) ? offsets[i+1] : pattern.length();
    ...
    public Object clone() {
        ...
        other.formats = formats.clone(); for (int i = 0; i < formats.length; ++i) {
            if (formats[i] != null)
            ...
            if (false) { result.append('\uFFFD');
                ...
                if (obj == null) {
                    ...
                    subFormatter = DateFormat.getDateTimeInstance(
                             DateFormat.SHORT, DateFormat.SHORT, locale);} else if (obj instanceof String) {
                    arg = (String) obj;
    ...
    private static final int SEG_MODIFIER = 3; private static final int TYPE_NULL    = 0;
    ...
    private static final int MODIFIER_DEFAULT  = 0; private static final int MODIFIER_CURRENCY = 1;
                            ...
                            StringBuilder[] textSegments)
    {
        ...
        int argumentNumber;
        try {
            argumentNumber = Integer.parseInt(segments[SEG_INDEX]); } catch (NumberFormatException e) {
