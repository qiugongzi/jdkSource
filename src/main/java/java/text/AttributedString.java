...
public class AttributedString {
    ...
    int runArraySize;               int runCount;                   int runStarts[];                Vector<Attribute> runAttributes[];         Vector<Object> runAttributeValues[];    AttributedString(AttributedCharacterIterator[] iterators) {
        if (iterators == null) {
    ...
    private void addAttributeRunData(Attribute attribute, Object value,
        ...
        for (int i = beginRunIndex; i < endRunIndex; i++) {
            int keyValueIndex = -1; if (runAttributes[i] == null) {
