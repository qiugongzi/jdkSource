...
public final class MathContext implements Serializable {
    ...
    public MathContext(String val) {
        ...
        try { if (!val.startsWith("precision=")) throw new RuntimeException();
            int fence = val.indexOf(' ');    int off = 10;                     setPrecision = Integer.parseInt(val.substring(10, fence));
    ...
    private void readObject(java.io.ObjectInputStream s)
        ...
        s.defaultReadObject();     if (precision < MIN_DIGITS) {
