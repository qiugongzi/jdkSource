...
public class NTLoginModule implements LoginModule {
    ...
    private NTUserPrincipal userPrincipal;              private NTSidUserPrincipal userSID;                 private NTDomainPrincipal userDomain;               private NTSidDomainPrincipal domainSID;             private NTSidPrimaryGroupPrincipal primaryGroup;    private NTSidGroupPrincipal groups[];               private NTNumericCredential iToken;                 public void initialize(Subject subject, CallbackHandler callbackHandler,
    ...
    public boolean login() throws LoginException {
        ...
        succeeded = false; ntSystem = new NTSystem(debugNative);
        if (ntSystem == null) {
            if (debug) {
