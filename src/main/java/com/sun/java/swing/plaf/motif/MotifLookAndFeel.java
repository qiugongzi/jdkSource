...
public class MotifLookAndFeel extends BasicLookAndFeel
{
    ...
    protected void initComponentDefaults(UIDefaults table)
    {
        ...
        ColorUIResource controlDarker = new ColorUIResource(147, 151, 165);  ColorUIResource scrollBarTrack = controlDarker;
       ...
       "shift ctrl alt F6", "selectPreviousFrame",
          ...
          "shift ctrl F12", "navigatePrevious"
            ...
            "Separator.shadow", table.get("controlShadow"),          "Separator.highlight", table.get("controlLtHighlight"),  "Separator.background", table.get("controlLtHighlight"),
            ...
            "Tree.background", controlDarker,                              "Tree.hash", table.get("controlDkShadow"),                     "Tree.iconShadow", table.get("controlShadow"),
            "Tree.iconHighlight", table.get("controlHighlight"),
            "Tree.iconBackground", table.get("control"),
            "Tree.iconForeground", table.get("controlShadow"),             "Tree.textBackground", controlDarker,             "Tree.textForeground", table.get("textText"),           "Tree.selectionBackground", table.get("text"),            "Tree.selectionForeground", table.get("textText"),              "Tree.selectionBorderColor", table.get("activeCaptionBorder"), "Tree.openIcon", treeOpenIcon,
