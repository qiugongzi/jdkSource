...
class TMSchema {
    ...
    public static enum Part {
        MENU (Control.MENU, 0), MP_BARBACKGROUND   (Control.MENU, 7),
    ...
    public static enum State {
        ...
        ICONSORTEDPRESSED,
        INACTIVE,
        INACTIVENORMAL,         INACTIVEHOT,            INACTIVEPUSHED,         INACTIVEDISABLED,       LEFTDISABLED,
        LEFTHOT,
        LEFTNORMAL,
        LEFTPRESSED,
        MIXEDDISABLED,
        ...
        private static synchronized void initStates() {
            ...
            State[] frameButtonStates = new State[] {
                        NORMAL,         HOT,         PUSHED,         DISABLED,  INACTIVENORMAL, INACTIVEHOT, INACTIVEPUSHED, INACTIVEDISABLED,
            };
