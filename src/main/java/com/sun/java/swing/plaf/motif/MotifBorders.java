...
public class MotifBorders {
    ...
    public static class BevelBorder extends AbstractBorder implements UIResource {
        ...
        public void paintBorder(Component c, Graphics g, int x, int y, int w, int h) {
            ...
            g.drawLine(x, y, x+w-1, y);           g.drawLine(x, y+h-1, x, y+1);         g.setColor((isRaised) ? darkShadow : lightShadow);
    ...
    public static void drawBezel(Graphics g, int x, int y, int w, int h,
        ...
        if (isPressed) {
            ...
            g.setColor(shadow);         g.drawRect(1, 1, w-3, h-3);

            g.setColor(highlight);    g.drawLine(2, h-3, w-3, h-3);
            ...
            if (hasFocus) {
                ...
                g.setColor(highlight);   g.drawLine(1, 1, 1, h-3);
                ...
                g.setColor(darkShadow);        g.drawLine(1, h-2, w-2, h-2);
