    ...
    public void paint(Graphics g) {
        ...
        if(getBasicSplitPaneUI().getOrientation() ==
           JSplitPane.HORIZONTAL_SPLIT) {
            ...
            g.setColor(highlightColor);
            g.drawLine(x, y, x+hThumbWidth-1, y);       g.drawLine(x, y+1, x, y+hThumbHeight-1);    g.setColor(shadowColor);
            g.drawLine(x+1, y+hThumbHeight-1,
                       x+hThumbWidth-1, y+hThumbHeight-1);      g.drawLine(x+hThumbWidth-1, y+1,
                       x+hThumbWidth-1, y+hThumbHeight-2);      } else {
            ...
            g.setColor(highlightColor);
            g.drawLine(x, y, x+vThumbWidth, y);    g.drawLine(x, y+1, x, y+vThumbHeight); g.setColor(shadowColor);
            g.drawLine(x+1, y+vThumbHeight,
                       x+vThumbWidth, y+vThumbHeight);          g.drawLine(x+vThumbWidth, y+1,
