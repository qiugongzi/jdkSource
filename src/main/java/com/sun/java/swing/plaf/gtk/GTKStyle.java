    ...
    static class GTKStockIconInfo {
        ...
        private static Dimension[] getIconSizesMap() {
            ...
            if (iconSizes == null) {
                ...
                iconSizes[0] = null;                  iconSizes[1] = new Dimension(16, 16); iconSizes[2] = new Dimension(18, 18); iconSizes[3] = new Dimension(24, 24); iconSizes[4] = new Dimension(20, 20); iconSizes[5] = new Dimension(32, 32); iconSizes[6] = new Dimension(48, 48); appContext.put(ICON_SIZE_KEY, iconSizes);
            }
            return iconSizes;
        }
