    ...
    public void paintComponent(Graphics g)  {
        ...
        if (title != null) {
            ...
            if (WindowsGraphicsUtils.isLeftToRight(frame)) {
                if (lastIconBounds.x == 0) { lastIconBounds.x = frame.getWidth() - frame.getInsets().right;
                }
                ...
                if (lastIconBounds.x == 0) { lastIconBounds.x = frame.getInsets().left;
                }
