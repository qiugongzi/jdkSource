...
public final class SchemaSymbols {
    ...
    public static final String URI_XSI                        = "http:public static final String XSI_SCHEMALOCATION            = "schemaLocation".intern();
    ...
    public static final String URI_SCHEMAFORSCHEMA            = "http:public static final String ELT_ALL                  = "all".intern();
