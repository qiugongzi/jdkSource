...
public final class Constants {
    ...
    public static final String NS_XMLSCHEMA = "http:public static final String NS_DTD = "http:public static final String SUN_SCHEMA_FEATURE_PREFIX = "http:public static final String SUN_REPORT_IGNORED_ELEMENT_CONTENT_WHITESPACE = "report-ignored-element-content-whitespace";

    public static final String ZEPHYR_PROPERTY_PREFIX = "http:public static final String STAX_PROPERTIES = "stax-properties" ;
    ...
    public static final String SUN_DOM_PROPERTY_PREFIX = "http:public static final String SUN_DOM_ANCESTOR_CHECCK = "ancestor-check";


    public static final String IGNORE_EXTERNAL_DTD = "ignore-external-dtd";

    public static final String SAX_FEATURE_PREFIX = "http:public static final String NAMESPACES_FEATURE = "namespaces";
    ...
    public static final String SAX_PROPERTY_PREFIX = "http:public static final String DECLARATION_HANDLER_PROPERTY = "declaration-handler";
    ...
    public static final String FEATURE_SECURE_PROCESSING = "http:public static final String ORACLE_FEATURE_SERVICE_MECHANISM = "http:public static final String DOCUMENT_XML_VERSION_PROPERTY = "document-xml-version";


    public static final String JAXP_PROPERTY_PREFIX =
        "http:public static final String SCHEMA_SOURCE = "schemaSource";
    ...
    public static final String JAXPAPI_PROPERTY_PREFIX =
        "http:public static final String ORACLE_JAXP_PROPERTY_PREFIX =
        "http:public static final String XML_SECURITY_PROPERTY_MANAGER =
    ...
    public static final String XERCES_FEATURE_PREFIX = "http:public static final String SCHEMA_VALIDATION_FEATURE = "validation/schema";
    ...
    public static final String XERCES_PROPERTY_PREFIX = "http:public static final String CURRENT_ELEMENT_NODE_PROPERTY = "dom/current-element-node";
    ...
    public final static String ANONYMOUS_TYPE_NAMESPACE =
        "http:public final static boolean SCHEMA_1_1_SUPPORT = false;
