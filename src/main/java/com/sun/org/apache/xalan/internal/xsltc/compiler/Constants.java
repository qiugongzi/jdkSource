...
public interface Constants extends InstructionConstants {
    ...
    public static final String NAMESPACE_FEATURE =
        "http:public static final String TRANSLET_INTF
    ...
    public static final String DOM_IMPL_CLASS
        = "com/sun/org/apache/xalan/internal/xsltc/DOM"; public static final String SAX_IMPL_CLASS
        = "com/sun/org/apache/xalan/internal/xsltc/DOM/SAXImpl";
    public static final String DOM_IMPL_SIG
        = "Lcom/sun/org/apache/xalan/internal/xsltc/dom/SAXImpl;"; public static final String SAX_IMPL_SIG
  ...
  = "dom";
    ...
    public static final String XMLNS_URI
        = "http:public static final String XSLT_URI
        = "http:public static final String XHTML_URI
        = "http:public static final String TRANSLET_URI
        = "http:public static final String REDIRECT_URI
        = "http:public static final String FALLBACK_CLASS
