...
public class Constants extends com.sun.org.apache.xml.internal.utils.Constants
{
  ...
  ELEMNAME_APPLY_TEMPLATES = 50, ELEMNAME_USE = 34, ELEMNAME_CHILDREN = 6,
                                 ELEMNAME_CHOOSE = 37, ELEMNAME_COMMENT = 59,  ELEMNAME_CONSTRUCT = 7,  ELEMNAME_CONTENTS = 8, ELEMNAME_COPY = 9,
                                 ELEMNAME_COPY_OF = 74,
                                 ELEMNAME_DECIMALFORMAT = 83,
                                 ELEMNAME_DEFINEATTRIBUTESET = 40,

  ELEMNAME_DEFINESCRIPT = 11, ELEMNAME_DISPLAYIF = 12,  ELEMNAME_EMPTY = 14, ELEMNAME_EVAL = 15,
  ...
  ELEMNAME_ROOT = 44, ELEMNAME_ANY = 45, ELEMNAME_ELEMENT = 46,
                      ...
                      ELEMNAME_TARGETATTRIBUTE = 49, ELEMNAME_URL = 52,  ELEMNAME_CALL = 55,  ELEMNAME_FALLBACK = 57,  ELEMNAME_TARGETPI = 60,  ELEMNAME_TARGETCOMMENT = 61,  ELEMNAME_TARGETTEXT = 62,  ELEMNAME_CSSSTYLECONVERSION = 65,  ELEMNAME_COUNTER = 66, ELEMNAME_COUNTERS = 67,
  ...
  public static final String
      ...
      ELEMNAME_ANY_STRING = "any",  ELEMNAME_APPLY_IMPORTS_STRING = "apply-imports",
      ELEMNAME_APPLY_TEMPLATES_STRING = "apply-templates",
      ELEMNAME_ARG_STRING = "arg",
      ELEMNAME_ATTRIBUTESET_STRING = "attribute-set",
      ELEMNAME_ATTRIBUTE_STRING = "attribute",  ELEMNAME_CALLTEMPLATEARG_STRING = "invoke-arg",
      ...
      ELEMNAME_CONSTRUCT_STRING = "construct",  ELEMNAME_CONTENTS_STRING = "contents",
      ...
      ELEMNAME_DISPLAYIF_STRING = "display-if",  ELEMNAME_ELEMENT_STRING = "element",  ELEMNAME_EMPTY_STRING = "empty",
      ...
      ELEMNAME_ROOT_STRING = "root",  ELEMNAME_SCRIPT_STRING = "script",
      ELEMNAME_SORT_STRING = "sort",
      ELEMNAME_STRIPSPACE_STRING = "strip-space",
      ELEMNAME_STYLESHEET_STRING = "stylesheet",
      ELEMNAME_TARGETATTRIBUTE_STRING = "target-attribute",  ELEMNAME_TARGETCOMMENT_STRING = "target-comment",
      ELEMNAME_TARGETELEMENT_STRING = "target-element",  ELEMNAME_TARGETPI_STRING = "target-pi",
      ...
      ELEMNAME_URL_STRING = "uri",  ELEMNAME_USE_STRING = "use",
  ...
  public static final String
      ...
      ATTRNAME_OUTPUT_METHOD = "method",  ATTRNAME_OUTPUT_OMITXMLDECL = "omit-xml-declaration",
      ...
      ATTRNAME_XMLNS = "xmlns:", ATTRNAME_XMLNSDEF = "xmlns", ATTRNAME_XMLSPACE = "xml:space",
