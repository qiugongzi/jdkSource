...
public class EnvironmentCheck
{
  ...
  public String[] jarNames =
  {
    ...
    "serializer.jar",   "xerces.jar",       "xercesImpl.jar",   "testxsl.jar",
    "crimson.jar",
    "lotusxsl.jar",
              ...
              || "xercesImpl.jar".equalsIgnoreCase(jarName))
{
  ...
  protected void checkAntVersion(Map<String, Object> h)
  {
    ...
    try
    {
      ...
      final String ANT_VERSION_METHOD = "getAntVersion"; final Class noArgs[] = new Class[0];
  ...
  protected boolean checkDOML3(Map<String, Object> h)
  {
    ...
    final String DOM_LEVEL3_METHOD = "getDoctype";  try
    {
  ...
  protected void checkDOMVersion(Map<String, Object> h)
  {
    ...
    final String DOM_LEVEL2_METHOD = "createElementNS";  final String DOM_LEVEL3_METHOD = "getDoctype";  final String DOM_LEVEL2WD_CLASS = "org.w3c.dom.Node";
    final String DOM_LEVEL2WD_METHOD = "supported";  final String DOM_LEVEL2FD_CLASS = "org.w3c.dom.Node";
    final String DOM_LEVEL2FD_METHOD = "isSupported";  final Class twoStringArgs[] = { java.lang.String.class,
  ...
  protected void checkSAXVersion(Map<String, Object> h)
  {
    ...
    final String SAX_VERSION1_METHOD = "parse";  final String SAX_VERSION2_CLASS = "org.xml.sax.XMLReader";
    final String SAX_VERSION2_METHOD = "parse";  final String SAX_VERSION2BETA_CLASSNF = "org.xml.sax.helpers.AttributesImpl";
    final String SAX_VERSION2BETA_METHODNF = "setAttributes";  final Class oneStringArg[] = { java.lang.String.class };
