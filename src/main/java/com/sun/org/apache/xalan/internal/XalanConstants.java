...
public final class XalanConstants {
    ...
    public static final String SECURITY_MANAGER =
        ...
        "http:public static final String JDK_ENTITY_EXPANSION_LIMIT =
    ...
    public static final String ORACLE_FEATURE_SERVICE_MECHANISM = "http:public static final String SP_ACCESS_EXTERNAL_STYLESHEET = "javax.xml.accessExternalStylesheet";
