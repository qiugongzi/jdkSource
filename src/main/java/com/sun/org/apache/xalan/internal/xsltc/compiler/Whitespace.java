...
final class Whitespace extends TopLevelElement {
    ...
    public static final int RULE_ELEMENT   = 1; public static final int RULE_NAMESPACE = 2; public static final int RULE_ALL       = 3; private String _elementList;
    private int    _action;
    ...
    private final static class WhitespaceRule {
        ...
        private String _namespace; private String _element;   private int    _type;
        ...
        public WhitespaceRule(int action, String element, int precedence) {
            ...
            if (_element.equals("*")) {
                if (_namespace == Constants.EMPTYSTRING) {
                    _type = RULE_ALL;       _priority += 2;         }
                else {
                    _type = RULE_NAMESPACE; _priority += 1;         }
            }
            else {
                _type = RULE_ELEMENT;       }
        }
