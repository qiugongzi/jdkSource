...
public class DTMManagerDefault extends DTMManager
{
  ...
  {
    if(null == node)
      throw new IllegalArgumentException(XMLMessages.createXMLMessage(XMLErrorResources.ER_NODE_NON_NULL, null)); if (node instanceof com.sun.org.apache.xml.internal.dtm.ref.DTMNodeProxy)
    ...
    else
    {
      ...
      if(DTM.NULL == handle)
        throw new RuntimeException(XMLMessages.createXMLMessage(XMLErrorResources.ER_COULD_NOT_RESOLVE_NODE, null)); return handle;
    }
  }
