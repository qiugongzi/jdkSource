...
public abstract class DTMDefaultBaseTraversers extends DTMDefaultBase
{
  ...
  public DTMAxisTraverser getAxisTraverser(final int axis)
  {
    ...
    {
      traverser = m_traversers[axis];  if (traverser != null)
        return traverser;
    }
  ...
  private class DescendantTraverser extends IndexedDTMAxisTraverser
  {
    ...
    public int next(int context, int current)
    {
      ...
      {
        int type = _type(current);  if (!isDescendant(subtreeRootIdent, current))
          return NULL;
    ...
    public int next(int context, int current, int expandedTypeID)
    {
      ...
      for (; ; current++)
      {
        int exptype = _exptype(current);  if (!isDescendant(subtreeRootIdent, current))
          return NULL;
  ...
  private class AllFromNodeTraverser extends DescendantOrSelfTraverser
  {
    ...
    public int next(int context, int current)
    {
      ...
      for (current = makeNodeIdentity(current) + 1; ; current++)
      {
        _exptype(current);  if (!isDescendant(subtreeRootIdent, current))
          return NULL;
  ...
  private class FollowingTraverser extends DescendantTraverser
  {
    ...
    public int next(int context, int current)
    {
      ...
      while (true)
      {
        current++; int type = _type(current);  if (NULL == type)
          return NULL;
    ...
    public int next(int context, int current, int expandedTypeID)
    {
      ...
      while (true)
      {
        ...
        int etype = _exptype(current);  if (NULL == etype)
          return NULL;
  ...
  private class AllFromRootTraverser extends AllFromNodeTraverser
  {
    ...
    public int next(int context, int current)
    {
      ...
      for (current = makeNodeIdentity(current) + 1; ; current++)
      {
                                int type = _type(current);  if (type == NULL)
          return NULL;
    ...
    public int next(int context, int current, int expandedTypeID)
    {
      ...
      for (current = makeNodeIdentity(current) + 1; ; current++)
      {
        int exptype = _exptype(current);  if (exptype == NULL)
          return NULL;
