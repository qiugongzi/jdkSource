...
public class Constants {
    ...
    public static final String SIGNATURESPECIFICATION_URL =
        "http:public static final String SignatureSpecNS = "http:public static final String SignatureSpec11NS = "http:public static final String MoreAlgorithmsSpecNS = "http:public static final String XML_LANG_SPACE_SpecNS = "http:public static final String NamespaceSpecNS = "http:public static final String _ATT_ALGORITHM = "Algorithm";
