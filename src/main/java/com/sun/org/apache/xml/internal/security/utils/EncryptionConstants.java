...
public class EncryptionConstants {
    ...
    public static final String ENCRYPTIONSPECIFICATION_URL =
        "http:public static final String EncryptionSpecNS =
        "http:public static final String EncryptionSpec11NS =
        "http:public static final String TYPE_CONTENT                = EncryptionSpecNS + "Content";
    ...
    public static final String TYPE_MEDIATYPE              =
        "http:public static final String ALGO_ID_BLOCKCIPHER_TRIPLEDES =
    ...
    public static final String ALGO_ID_BLOCKCIPHER_AES128_GCM =
        "http:public static final String ALGO_ID_BLOCKCIPHER_AES192_GCM =
        "http:public static final String ALGO_ID_BLOCKCIPHER_AES256_GCM =
        "http:public static final String ALGO_ID_KEYTRANSPORT_RSA15 =
    ...
    public static final String ALGO_ID_AUTHENTICATION_XMLSIGNATURE =
        "http:public static final String ALGO_ID_C14N_WITHCOMMENTS =
        "http:public static final String ALGO_ID_C14N_OMITCOMMENTS =
        "http:public static final String ALGO_ID_ENCODING_BASE64 =
        "http:public static final String MGF1_SHA1 =
