...
public final class HTMLdtd
{
    ...
    public static final String HTMLPublicId = "-public static final String HTMLSystemId =
        "http:public static final String XHTMLPublicId =
        "-public static final String XHTMLSystemId =
        "http:private static Map<Integer, String> _byChar;
