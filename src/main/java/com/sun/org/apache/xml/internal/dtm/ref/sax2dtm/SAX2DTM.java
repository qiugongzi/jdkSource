                   ...
                   DeclHandler, LexicalHandler
{
  ...
  private static final String[] m_fixednames = { null,
                    null,  null, "#text",  "#cdata_section", null,  null, null,  "#comment", "#document",  null, "#document-fragment",  null };  private Vector m_entities = null;
                 ...
                 boolean newNameTable)
  {
    ...
    m_data.addElement(0);   m_useSourceLocationProperty = mgr.getSource_location();
  ...
  public String getDocumentTypeDeclarationSystemIdentifier()
  {
    ...
    error(XMLMessages.createXMLMessage(XMLErrorResources.ER_METHOD_NOT_SUPPORTED, null));return null;
  }
...
protected int addNode(int type, int expandedTypeID,
  ...
  protected void charactersFlush()
  {
    ...
    if (m_textPendingStart >= 0)  {
      ...
      if (doStrip) {
        m_chars.setLength(m_textPendingStart);  } else {
        if (length > 0) {
          ...
          throws SAXException
  {
    ...
    if(null == prefix)
      prefix = "";
    m_prefixMappings.addElement(prefix);  m_prefixMappings.addElement(uri);  }
            ...
            throws SAXException
  {
   if (DEBUG)
    ...
    {
      prefix="xml";
      String declURL = "http:exName = m_expandedNameTable.getExpandedTypeID(null, prefix, DTM.NAMESPACE_NODE);
    ...
    for (int i = 0; i < n; i++)
    {
                  ...
                  || attrQName.startsWith("xmlns:")))
      {
        if (declAlreadyDeclared(prefix))
          continue;  nodeType = DTM.NAMESPACE_NODE;
      }
      else
      {
