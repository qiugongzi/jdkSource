...
import java.io.*; public abstract class DTMDefaultBase implements DTM
{
  ...
  public static final int DEFAULT_BLOCKSIZE = 512;  public static final int DEFAULT_NUMBLOCKS = 32;
...
protected short _type(int identity)
  ...
  private Vector m_namespaceLists = null;  protected void declareNamespaceInContext(int elementNodeIndex,int namespaceNodeIndex)
  {
    ...
    if (null!=m_namespaceDeclSetElements)
      {
        ...
        if(wouldBeAt == -1) return null; wouldBeAt=-1-wouldBeAt;
  ...
  public int getStringValueChunkCount(int nodeHandle)
  {
    ...
    error(XMLMessages.createXMLMessage(XMLErrorResources.ER_METHOD_NOT_SUPPORTED, null));return 0;
  }
