...
public class ClassGen extends AccessFlags implements Cloneable {
  ...
  private ConstantPoolGen cp; private ArrayList   field_vec     = new ArrayList();
  ...
  public void addEmptyConstructor(int access_flags) {
    ...
    il.append(InstructionConstants.THIS); il.append(new INVOKESPECIAL(cp.addMethodref(super_class_name,
                                                "<init>", "()V")));
