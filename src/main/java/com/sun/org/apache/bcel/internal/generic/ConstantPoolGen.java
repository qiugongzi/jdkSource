...
public class ConstantPoolGen implements java.io.Serializable {
  protected int        size      = 1024; protected Constant[] constants = new Constant[size];
  protected int        index     = 1; private static final String METHODREF_DELIM  = ":";
  ...
  public int addString(String str) {
    ...
    if((ret = lookupString(str)) != -1)
      return ret; int utf8 = addUtf8(str);
  ...
  public int addConstant(Constant c, ConstantPoolGen cp) {
    ...
    case Constants.CONSTANT_Fieldref: {
      ...
      default: throw new RuntimeException("Unknown constant type " + c);
      }
    }
