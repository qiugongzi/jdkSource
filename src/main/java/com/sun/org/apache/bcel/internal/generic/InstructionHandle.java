...
public class InstructionHandle implements java.io.Serializable {
  InstructionHandle next, prev;  Instruction       instruction;
  protected int     i_position = -1; private HashSet   targeters;
  ...
  public void setInstruction(Instruction i) { if(i == null)
  ...
  private static InstructionHandle ih_list = null; static final InstructionHandle getInstructionHandle(Instruction i) {
    if(ih_list == null)
