...
final class ConstantHTML implements com.sun.org.apache.bcel.internal.Constants {
  private String        class_name;     private String        class_package;  private ConstantPool  constant_pool;  private PrintWriter   file;           private String[]      constant_ref;   private Constant[]    constants;      private Method[]      methods;
  ...
  private void writeConstant(int index) {
    ...
    case CONSTANT_Methodref:
      ...
      String short_method_class         = Utility.compactClassName(method_class); short_method_class = Utility.compactClassName(method_class); short_method_class = Utility.compactClassName(short_method_class, class_package + ".", true); ConstantNameAndType c2 = (ConstantNameAndType)constant_pool.getConstant(name_index, CONSTANT_NameAndType);
      ...
      if(method_class.equals(class_name)) ref = "<A HREF=\"" + class_name + "_code.html#method" + getMethodNumber(method_name + signature) +
    ...
    case CONSTANT_Fieldref:
      ...
      String short_field_class = Utility.compactClassName(field_class); short_field_class = Utility.compactClassName(short_field_class, class_package + ".", true); String field_name  = constant_pool.constantToString(name_index, CONSTANT_NameAndType);

      if(field_class.equals(class_name)) ref = "<A HREF=\"" + field_class + "_methods.html#field" +
    ...
    case CONSTANT_Class:
      ...
      String class_name2  = constant_pool.constantToString(index, tag); String short_class_name = Utility.compactClassName(class_name2); short_class_name = Utility.compactClassName(short_class_name, class_package + ".", true); ref = "<A HREF=\"" + class_name2 + ".html\" TARGET=_top>" + short_class_name + "</A>";
