...
public class XPathParser
{
          ...
          throws javax.xml.transform.TransformerException
  {
    ...
    else
    {
      error(XPATHErrorResources.ER_EXPECTED_BUT_FOUND, new Object[]{ expected,
                                                                     m_token });  throw new XPathProcessorException(CONTINUE_AFTER_FATAL_ERROR);
        }
  }
  ...
  protected boolean PrimaryExpr() throws javax.xml.transform.TransformerException
  {
    ...
    {
      nextToken();  appendOp(2, OpCodes.OP_VARIABLE);
      QName();
  ...
  protected void Number() throws javax.xml.transform.TransformerException
  {
    ...
    if (null != m_token)
    {
      ...
      {
        num = 0.0;  error(XPATHErrorResources.ER_COULDNOT_BE_FORMATTED_TO_NUMBER,
              new Object[]{ m_token });  }
