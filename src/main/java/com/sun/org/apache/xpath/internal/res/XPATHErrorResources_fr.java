...
public static final String ER_IGNORABLE_WHITESPACE_NOT_HANDLED =
 ...
 public static final String ER_ONLY_ALLOWS = "ER_ONLY_ALLOWS";
  ...
  { ER_EXPECTED_REL_LOC_PATH,
      "Un chemin d'acc\u00E8s relatif \u00E9tait attendu apr\u00E8s le jeton '/' ou '{ ER_EXPECTED_LOC_PATH,
  ...
  { ER_EXPECTED_LOC_STEP,
       "Une \u00E9tape d'emplacement \u00E9tait attendue apr\u00E8s le jeton '/' ou '{ ER_EXPECTED_NODE_TEST,
  ...
  { "noParsermsg5", "AlphaWorks d'IBM : http:{ "gtone", ">1" },
  { "zero", "0" },
  { "one", "1" },
  { "two" , "2" },
  { "three", "3" }
