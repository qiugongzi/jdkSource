...
public static final String ER_IGNORABLE_WHITESPACE_NOT_HANDLED =
 ...
 public static final String ER_ONLY_ALLOWS = "ER_ONLY_ALLOWS";
  ...
  { ER_EXPECTED_REL_LOC_PATH,
      "Esperava-se um caminho de localiza\u00E7\u00E3o relativo, mas o seguinte token foi encontrado: '/' ou '{ ER_EXPECTED_LOC_PATH,
  ...
  { ER_EXPECTED_LOC_STEP,
       "Esperava-se uma etapa de localiza\u00E7\u00E3o seguinte ao token '/' ou '{ ER_EXPECTED_NODE_TEST,
  ...
  { "noParsermsg5", "AlphaWorks da IBM: http:{ "gtone", ">1" },
  { "zero", "0" },
  { "one", "1" },
  { "two" , "2" },
  { "three", "3" }
