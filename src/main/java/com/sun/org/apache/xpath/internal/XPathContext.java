...
public DTMIterator createDTMIterator(int whatToShow,
  ...
  public void reset()
  {
    ...
    m_rtfdtm_stack=null; m_which_rtfdtm=-1;
  ...
  {
    if (listener == null)
      throw new IllegalArgumentException(XSLMessages.createXPATHMessage(XPATHErrorResources.ER_NULL_ERROR_HANDLER, null)); m_errorListener = listener;
  }
