...
public static final String ER_IGNORABLE_WHITESPACE_NOT_HANDLED =
 ...
 public static final String ER_ONLY_ALLOWS = "ER_ONLY_ALLOWS";
  ...
  { ER_EXPECTED_REL_LOC_PATH,
      "Se esperaba una ruta de acceso de ubicaci\u00F3n relativa despu\u00E9s del token '/' o '{ ER_EXPECTED_LOC_PATH,
  ...
  { ER_EXPECTED_LOC_STEP,
       "Se esperaba un paso de ubicaci\u00F3n despu\u00E9s del token '/' o '{ ER_EXPECTED_NODE_TEST,
  ...
  { "noParsermsg5", "AlphaWorks de IBM: http:{ "gtone", ">1" },
  { "zero", "0" },
  { "one", "1" },
  { "two" , "2" },
  { "three", "3" }
