...
public static final String ER_IGNORABLE_WHITESPACE_NOT_HANDLED =
 ...
 public static final String ER_ONLY_ALLOWS = "ER_ONLY_ALLOWS";
  ...
  { ER_EXPECTED_REL_LOC_PATH,
      "A relative location path was expected following the '/' or '{ ER_EXPECTED_LOC_PATH,
  ...
  { ER_EXPECTED_LOC_STEP,
       "A location step was expected following the '/' or '{ ER_EXPECTED_NODE_TEST,
  ...
  { "noParsermsg5", "IBM's AlphaWorks: http:{ "gtone", ">1" },
  { "zero", "0" },
  { "one", "1" },
  { "two" , "2" },
  { "three", "3" }
