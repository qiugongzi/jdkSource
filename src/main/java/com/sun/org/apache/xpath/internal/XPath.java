...
public class XPath implements Serializable, ExpressionOwner
{
  ...
  {
        if(null != m_mainExp)
        exp.exprSetParent(m_mainExp.exprGetParent()); m_mainExp = exp;
  }
...
String m_patternString;
            ...
            throws javax.xml.transform.TransformerException
  {
    ...
    if (SELECT == type)
      ...
      throw new RuntimeException(XSLMessages.createXPATHMessage(XPATHErrorResources.ER_CANNOT_DEAL_XPATH_TYPE, new Object[]{Integer.toString(type)})); Expression expr = compiler.compile(0);
