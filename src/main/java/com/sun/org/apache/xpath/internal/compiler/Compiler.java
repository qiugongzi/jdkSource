...
case OpCodes.OP_NEG :
    ...
    case OpCodes.OP_PREDICATE :
      expr = null; break;  case OpCodes.OP_MATCHPATTERN :
...
private static final boolean DEBUG = false;
            ...
            throws TransformerException
  {
    ...
    case OpCodes.MATCH_IMMEDIATE_ANCESTOR :
      ...
      break;
    default :
      error(XPATHErrorResources.ER_UNKNOWN_MATCH_OPERATION, null);  return null;
    }
  ...
  Expression compileFunction(int opPos) throws TransformerException
  {
    ...
    {
      error(XPATHErrorResources.ER_FUNCTION_TOKEN_NOT_FOUND, null);  return null;
    }
  }
