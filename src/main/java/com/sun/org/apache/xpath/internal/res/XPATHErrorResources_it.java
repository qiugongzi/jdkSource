...
public static final String ER_IGNORABLE_WHITESPACE_NOT_HANDLED =
 ...
 public static final String ER_ONLY_ALLOWS = "ER_ONLY_ALLOWS";
  ...
  { ER_EXPECTED_REL_LOC_PATH,
      "\u00C8 previsto un percorso di posizione relativa dopo il token '/' o '{ ER_EXPECTED_LOC_PATH,
  ...
  { ER_EXPECTED_LOC_STEP,
       "\u00C8 previsto un passo di posizione dopo il token '/' o '{ ER_EXPECTED_NODE_TEST,
  ...
  { "noParsermsg5", "AlphaWorks di IBM: http:{ "gtone", ">1" },
  { "zero", "0" },
  { "one", "1" },
  { "two" , "2" },
  { "three", "3" }
