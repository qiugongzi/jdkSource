...
public abstract class MessageBase implements Message{
    ...
    public static MessageBase readGIOPHeader(ORB orb, CorbaConnection connection)
    {
        ...
        case GIOPRequest:
            ...
            if ( (buf.get(4) == 0x01) && (buf.get(5) == 0x00) ) { msg = new RequestMessage_1_0(orb);
            } else if ( (buf.get(4) == 0x01) && (buf.get(5) == 0x01) ) { msg = new RequestMessage_1_1(orb);
            } else if ( (buf.get(4) == 0x01) && (buf.get(5) == 0x02) ) { msg = new RequestMessage_1_2(orb);
            } else {
        ...
        case GIOPLocateRequest:
            ...
            if ( (buf.get(4) == 0x01) && (buf.get(5) == 0x00) ) { msg = new LocateRequestMessage_1_0(orb);
            } else if ( (buf.get(4) == 0x01) && (buf.get(5) == 0x01) ) { msg = new LocateRequestMessage_1_1(orb);
            } else if ( (buf.get(4) == 0x01) && (buf.get(5) == 0x02) ) { msg = new LocateRequestMessage_1_2(orb);
            } else {
                throw wrapper.giopVersionError(
                    CompletionStatus.COMPLETED_MAYBE);
            }
        ...
        case GIOPCancelRequest:
            ...
            if ( (buf.get(4) == 0x01) && (buf.get(5) == 0x00) ) { msg = new CancelRequestMessage_1_0();
            } else if ( (buf.get(4) == 0x01) && (buf.get(5) == 0x01) ) { msg = new CancelRequestMessage_1_1();
            } else if ( (buf.get(4) == 0x01) && (buf.get(5) == 0x02) ) { msg = new CancelRequestMessage_1_2();
            } else {
                throw wrapper.giopVersionError(
                    CompletionStatus.COMPLETED_MAYBE);
            }
        ...
        case GIOPReply:
            ...
            if ( (buf.get(4) == 0x01) && (buf.get(5) == 0x00) ) { msg = new ReplyMessage_1_0(orb);
            } else if ( (buf.get(4) == 0x01) && (buf.get(5) == 0x01) ) { msg = new ReplyMessage_1_1(orb);
            } else if ( (buf.get(4) == 0x01) && (buf.get(5) == 0x02) ) { msg = new ReplyMessage_1_2(orb);
            } else {
                throw wrapper.giopVersionError(
                    CompletionStatus.COMPLETED_MAYBE);
            }
        ...
        case GIOPLocateReply:
            ...
            if ( (buf.get(4) == 0x01) && (buf.get(5) == 0x00) ) { msg = new LocateReplyMessage_1_0(orb);
            } else if ( (buf.get(4) == 0x01) && (buf.get(5) == 0x01) ) { msg = new LocateReplyMessage_1_1(orb);
            } else if ( (buf.get(4) == 0x01) && (buf.get(5) == 0x02) ) { msg = new LocateReplyMessage_1_2(orb);
            } else {
                throw wrapper.giopVersionError(
                    CompletionStatus.COMPLETED_MAYBE);
            }
        ...
        case GIOPMessageError:
            ...
            if ( (buf.get(4) == 0x01) && (buf.get(5) == 0x00) ) { msg = new Message_1_0();
            } else if ( (buf.get(4) == 0x01) && (buf.get(5) == 0x01) ) { msg = new Message_1_1();
            } else if ( (buf.get(4) == 0x01) && (buf.get(5) == 0x02) ) { msg = new Message_1_1();
            } else {
                throw wrapper.giopVersionError(
                    CompletionStatus.COMPLETED_MAYBE);
            }
        ...
        case GIOPFragment:
            ...
            if ( (buf.get(4) == 0x01) && (buf.get(5) == 0x00) ) { } else if ( (buf.get(4) == 0x01) && (buf.get(5) == 0x01) ) { msg = new FragmentMessage_1_1();
            } else if ( (buf.get(4) == 0x01) && (buf.get(5) == 0x02) ) { msg = new FragmentMessage_1_2();
            } else {
                throw wrapper.giopVersionError(
                    CompletionStatus.COMPLETED_MAYBE);
            }
        ...
        if ( (buf.get(4) == 0x01) && (buf.get(5) == 0x00) ) { Message_1_0 msg10 = (Message_1_0) msg;
            msg10.magic = magic;
        ...
        } else { Message_1_1 msg11 = (Message_1_1) msg;
            msg11.magic = magic;
    ...
    private static RequestMessage createRequest(
        ...
        if (gv.equals(GIOPVersion.V1_0)) { return new RequestMessage_1_0(orb, service_contexts, request_id,
                                         response_expected, object_key,
                                         operation, requesting_principal);
        } else if (gv.equals(GIOPVersion.V1_1)) { return new RequestMessage_1_1(orb, service_contexts, request_id,
                response_expected, new byte[] { 0x00, 0x00, 0x00 },
                object_key, operation, requesting_principal);
        } else if (gv.equals(GIOPVersion.V1_2)) { byte response_flags = 0x03;
    ...
    public static RequestMessage createRequest(
        ...
        if (addrDisp == KeyAddr.value) {
            ...
            TargetAddress target = new TargetAddress();
            if (addrDisp == ProfileAddr.value) { profile = ior.getProfile();
                target.profile(profile.getIOPProfile());
            } else if (addrDisp == ReferenceAddr.value) {  IORAddressingInfo iorInfo =
                    new IORAddressingInfo( 0, ior.getIOPIOR());
                target.ior(iorInfo);
            } else {
        ...
        if (gv.supportsIORIIOPProfileComponents()) {
            int poolToUse = 0; IIOPProfileTemplate temp =
    ...
    public static ReplyMessage createReply(
        ...
        if (gv.equals(GIOPVersion.V1_0)) { return new ReplyMessage_1_0(orb, service_contexts, request_id,
                                        reply_status, ior);
        } else if (gv.equals(GIOPVersion.V1_1)) { return new ReplyMessage_1_1(orb, service_contexts, request_id,
                                        reply_status, ior);
        } else if (gv.equals(GIOPVersion.V1_2)) { ReplyMessage msg =
    ...
    public static LocateRequestMessage createLocateRequest(
        ...
        if (gv.equals(GIOPVersion.V1_0)) { return new LocateRequestMessage_1_0(orb, request_id, object_key);
        } else if (gv.equals(GIOPVersion.V1_1)) { return new LocateRequestMessage_1_1(orb, request_id, object_key);
        } else if (gv.equals(GIOPVersion.V1_2)) { TargetAddress target = new TargetAddress();
            target.object_key(object_key);
    ...
    public static LocateReplyMessage createLocateReply(
        ...
        if (gv.equals(GIOPVersion.V1_0)) { return new LocateReplyMessage_1_0(orb, request_id,
                                              locate_status, ior);
        } else if (gv.equals(GIOPVersion.V1_1)) { return new LocateReplyMessage_1_1(orb, request_id,
                                              locate_status, ior);
        } else if (gv.equals(GIOPVersion.V1_2)) { LocateReplyMessage msg =
    ...
    public static CancelRequestMessage createCancelRequest(
        ...
        if (gv.equals(GIOPVersion.V1_0)) { return new CancelRequestMessage_1_0(request_id);
        } else if (gv.equals(GIOPVersion.V1_1)) { return new CancelRequestMessage_1_1(request_id);
        } else if (gv.equals(GIOPVersion.V1_2)) { return new CancelRequestMessage_1_2(request_id);
        } else {
            throw wrapper.giopVersionError(
                CompletionStatus.COMPLETED_MAYBE);
        }
    ...
    public static Message createCloseConnection(GIOPVersion gv) {
        if (gv.equals(GIOPVersion.V1_0)) { return new Message_1_0(Message.GIOPBigMagic, false,
                                   Message.GIOPCloseConnection, 0);
        } else if (gv.equals(GIOPVersion.V1_1)) { return new Message_1_1(Message.GIOPBigMagic, GIOPVersion.V1_1,
                                   FLAG_NO_FRAG_BIG_ENDIAN,
                                   Message.GIOPCloseConnection, 0);
        } else if (gv.equals(GIOPVersion.V1_2)) { return new Message_1_1(Message.GIOPBigMagic, GIOPVersion.V1_2,
                                   FLAG_NO_FRAG_BIG_ENDIAN,
                                   Message.GIOPCloseConnection, 0);
        } else {
            throw wrapper.giopVersionError(
    ...
    private static void AreFragmentsAllowed(byte major, byte minor, byte flag,
        ...
        if ( (major == 0x01) && (minor == 0x00) ) { if (msgType == GIOPFragment) {
        ...
        if ( (flag & MORE_FRAGMENTS_BIT) == MORE_FRAGMENTS_BIT ) {
            ...
            case GIOPLocateRequest :
            case GIOPLocateReply :
                if ( (major == 0x01) && (minor == 0x01) ) { throw wrapper.fragmentationDisallowed(
                        CompletionStatus.COMPLETED_MAYBE);
                }
                break;
            }
    ...
    static ObjectKey extractObjectKey(TargetAddress target, ORB orb) {
        ...
        try {
            ...
            case KeyAddr.value :
                ...
                if (objKey != null) { ObjectKey objectKey =
                        orb.getObjectKeyFactory().create(objKey);
                    if (objectKey != null) {
                       return objectKey;
                   }
            ...
            case ProfileAddr.value :
                ...
                if (profile != null) { iiopProfile = IIOPFactories.makeIIOPProfile(orb, profile);
            ...
            case ReferenceAddr.value :
                ...
                if (iorInfo != null) { profile = iorInfo.ior.profiles[iorInfo.selected_profile_index];
