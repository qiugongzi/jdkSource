...
public final class TypeCodeImpl extends TypeCode
{
    ...
    private static final int EMPTY = 0; private static final int SIMPLE = 1;        private static final int COMPLEX = 2; private static final int typeTable[] = {
        EMPTY,  EMPTY,  EMPTY,  EMPTY,  EMPTY,  EMPTY,  EMPTY,  EMPTY,  EMPTY,  EMPTY,  EMPTY,  EMPTY,  EMPTY,  EMPTY,  COMPLEX,        COMPLEX,        COMPLEX,        COMPLEX,        SIMPLE, COMPLEX,        COMPLEX,        COMPLEX,        COMPLEX,        EMPTY,  EMPTY,  EMPTY,  EMPTY,  SIMPLE, SIMPLE, COMPLEX,        COMPLEX,        COMPLEX,        COMPLEX };
    ...
    private int                 _kind           = 0;    private String          _id             = "";   private String          _name           = "";   private int             _memberCount    = 0;    private String          _memberNames[]  = null; private TypeCodeImpl    _memberTypes[]  = null; private AnyImpl         _unionLabels[]  = null; private TypeCodeImpl    _discriminator  = null; private int             _defaultIndex   = -1;   private int             _length         = 0;    private TypeCodeImpl    _contentType    = null; private short           _digits         = 0;
    private short           _scale          = 0;
    private short           _type_modifier  = -1;   private TypeCodeImpl    _concrete_base  = null; private short           _memberAccess[] = null; private TypeCodeImpl    _parent         = null; private int             _parentOffset   = 0;    private TypeCodeImpl    _indirectType   = null;
        ...
        org.omg.CORBA.portable.OutputStream dst)
    {
        ...
        case TCKind._tk_sequence:
            ...
            lazy_content_type(); for (int i=0; i < seqLength; i++)
