                                          ...
                                          org.omg.SendingContext.RunTime _sender)
    {
        ...
        if (!useHashtables) {
            if (inputStreamBridge == null) {
                ...
                inputStreamBridge.setSender(sender); inputStreamBridge.setValueHandler(this);
            }
        ...
        if (jdkToOrbInputStreamBridge == null) {
            ...
            jdkToOrbInputStreamBridge.setSender(sender); jdkToOrbInputStreamBridge.setValueHandler(this);
