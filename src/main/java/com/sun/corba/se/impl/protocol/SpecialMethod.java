...
class NotExistent extends NonExistent {
    public String getName() {           return "_not_existent";
    }
}

class IsA extends SpecialMethod  {      public boolean isNonExistentMethod()
    {
        return false ;
    }
...
class GetInterface extends SpecialMethod  {     public boolean isNonExistentMethod()
    {
        return false ;
    }
