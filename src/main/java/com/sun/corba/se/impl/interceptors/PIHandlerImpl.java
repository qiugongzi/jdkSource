...
public class PIHandlerImpl implements PIHandler
{
    ...
    private boolean hasClientInterceptors;  private boolean hasServerInterceptors;
    ...
    private final static short REPLY_MESSAGE_TO_PI_REPLY_STATUS[] = {
        SUCCESSFUL.value,       USER_EXCEPTION.value,   SYSTEM_EXCEPTION.value, LOCATION_FORWARD.value, LOCATION_FORWARD.value, TRANSPORT_RETRY.value   };
