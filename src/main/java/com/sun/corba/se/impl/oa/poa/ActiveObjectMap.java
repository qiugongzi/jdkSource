...
public abstract class ActiveObjectMap
{
    ...
    private Map keyToEntry = new HashMap() ;     private Map entryToServant = new HashMap() ; private Map servantToEntry = new HashMap() ; public final boolean contains(Servant value)
    {
...
{
    private Map entryToKey = new HashMap() ;    public SingleObjectMap( POAImpl poa )
    {
        super( poa ) ;
    }
...
{
    private Map entryToKeys = new HashMap() ;   public MultipleObjectMap( POAImpl poa )
    {
        super( poa ) ;
    }
