...
public class ValueUtility {
    ...
    private static final String primitiveConstants[] = {
        null,       null,           "S",            "I",            "S",            "I",            "F",            "D",            "Z",            "C",            "B",            null,           null,           null,           null,           null,           null,           null,           null,           null,           null,           null,           null,           "J",            "J",            "D",            "C",            null,           null,       null,       null,       null,       null,       };
    ...
    public static FullValueDescription translate(ORB orb, ObjectStreamClass osc, ValueHandler vh){
        ...
        result.type = orb.get_primitive_tc(TCKind.tk_value); return result;
                                                   ...
                                                   IdentityKeyValueStack createdIDs)
    {
        ...
        for (int i = 0; i < fieldsLength; i++) {
            ...
            members[i].id = valRepId; members[i].defined_in = vhandler.getDefinedInId(valRepId);members[i].version = "1.0";
            members[i].type_def = new _IDLTypeStub(); if (fields[i].getField() == null) {
            ...
            case 'B':
                members[i].type = orb.get_primitive_tc(TCKind.tk_octet); break;
            case 'C':
                members[i].type
                    = orb.get_primitive_tc(vhandler.getJavaCharTCKind()); break;
            case 'F':
                members[i].type = orb.get_primitive_tc(TCKind.tk_float); break;
            case 'D' :
                members[i].type = orb.get_primitive_tc(TCKind.tk_double); break;
            case 'I':
                members[i].type = orb.get_primitive_tc(TCKind.tk_long); break;
            case 'J':
                members[i].type = orb.get_primitive_tc(TCKind.tk_longlong); break;
            case 'S':
                members[i].type = orb.get_primitive_tc(TCKind.tk_short); break;
            case 'Z':
                members[i].type = orb.get_primitive_tc(TCKind.tk_boolean); break;
        default:
