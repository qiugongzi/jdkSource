...
public class IDLJavaSerializationInputStream extends CDRInputStreamBase {
    ...
    public boolean read_boolean() {
        if (!markOn && !(markedItemQ.isEmpty())) { return ((Boolean)markedItemQ.removeFirst()).booleanValue();
        }
        if (markOn && !(markedItemQ.isEmpty()) &&
                (peekIndex < peekCount)) { return ((Boolean)markedItemQ.get(peekIndex++)).booleanValue();
        }
        try {
            boolean value = is.readBoolean();
            if (markOn) { markedItemQ.addLast(Boolean.valueOf(value));
            }
            return value;
        } catch (Exception e) {
    ...
    public char read_char() {
        if (!markOn && !(markedItemQ.isEmpty())) { return ((Character)markedItemQ.removeFirst()).charValue();
        }
        if (markOn && !(markedItemQ.isEmpty()) &&
                (peekIndex < peekCount)) { return ((Character)markedItemQ.get(peekIndex++)).charValue();
        }
        try {
            char value = is.readChar();
            if (markOn) { markedItemQ.addLast(new Character(value));
            }
            return value;
        } catch (Exception e) {
    ...
    public byte read_octet() {
        ...
        if (!markOn && !(markedItemQ.isEmpty())) { return ((Byte)markedItemQ.removeFirst()).byteValue();
        }

        if (markOn && !(markedItemQ.isEmpty()) &&
                (peekIndex < peekCount)) { return ((Byte)markedItemQ.get(peekIndex++)).byteValue();
        }

        try {
            byte value = is.readByte();
            if (markOn) { markedItemQ.addLast(new Byte(value));
            }
            return value;
        } catch (Exception e) {
    ...
    public short read_short() {
        if (!markOn && !(markedItemQ.isEmpty())) { return ((Short)markedItemQ.removeFirst()).shortValue();
        }
        if (markOn && !(markedItemQ.isEmpty()) &&
                (peekIndex < peekCount)) { return ((Short)markedItemQ.get(peekIndex++)).shortValue();
        }

        try {
            short value = is.readShort();
            if (markOn) { markedItemQ.addLast(new Short(value));
            }
            return value;
        } catch (Exception e) {
    ...
    public int read_long() {
        ...
        if (!markOn && !(markedItemQ.isEmpty())) { return ((Integer)markedItemQ.removeFirst()).intValue();
        }

        if (markOn && !(markedItemQ.isEmpty()) &&
                (peekIndex < peekCount)) { return ((Integer)markedItemQ.get(peekIndex++)).intValue();
        }

        try {
            int value = is.readInt();
            if (markOn) { markedItemQ.addLast(new Integer(value));
            }
            return value;
        } catch (Exception e) {
    ...
    public long read_longlong() {
        if (!markOn && !(markedItemQ.isEmpty())) { return ((Long)markedItemQ.removeFirst()).longValue();
        }
        if (markOn && !(markedItemQ.isEmpty()) &&
                (peekIndex < peekCount)) { return ((Long)markedItemQ.get(peekIndex++)).longValue();
        }

        try {
            long value = is.readLong();
            if (markOn) { markedItemQ.addLast(new Long(value));
            }
            return value;
        } catch (Exception e) {
    ...
    public float read_float() {
        if (!markOn && !(markedItemQ.isEmpty())) { return ((Float)markedItemQ.removeFirst()).floatValue();
        }
        if (markOn && !(markedItemQ.isEmpty()) &&
                (peekIndex < peekCount)) { return ((Float)markedItemQ.get(peekIndex++)).floatValue();
        }

        try {
            float value = is.readFloat();
            if (markOn) { markedItemQ.addLast(new Float(value));
            }
            return value;
        } catch (Exception e) {
    ...
    public double read_double() {
        if (!markOn && !(markedItemQ.isEmpty())) { return ((Double)markedItemQ.removeFirst()).doubleValue();
        }
        if (markOn && !(markedItemQ.isEmpty()) &&
                (peekIndex < peekCount)) { return ((Double)markedItemQ.get(peekIndex++)).doubleValue();
        }

        try {
            double value = is.readDouble();
            if (markOn) { markedItemQ.addLast(new Double(value));
            }
            return value;
        } catch (Exception e) {
    ...
    public String read_string() {
        if (!markOn && !(markedItemQ.isEmpty())) { return (String) markedItemQ.removeFirst();
        }
        if (markOn && !(markedItemQ.isEmpty()) &&
            (peekIndex < peekCount)) { return (String) markedItemQ.get(peekIndex++);
        }
        try {
            String value = is.readUTF();
            if (markOn) { markedItemQ.addLast(value);
            }
            return value;
        } catch (Exception e) {
    ...
    public java.io.Serializable read_value() {
        if (!markOn && !(markedItemQ.isEmpty())) { return (Serializable) markedItemQ.removeFirst();
        }
        if (markOn && !(markedItemQ.isEmpty()) &&
                (peekIndex < peekCount)) { return (Serializable) markedItemQ.get(peekIndex++);
        }
        try {
