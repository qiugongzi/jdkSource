...
final class IDLJavaSerializationOutputStream extends CDROutputStreamBase {
    ...
    public final void write_octet(byte value) {
        ...
        if (bos.size() < directWriteLength) {
            bos.write(value); if (bos.size() == directWriteLength) {
    ...
    public final void write_abstract_interface(java.lang.Object obj) {
        ...
        boolean isCorbaObject = false; org.omg.CORBA.Object theCorbaObject = null;
    ...
    public final byte[] toByteArray() {
        try {
            os.flush();
            return bos.toByteArray(); } catch (Exception e) {
    ...
    public final void writeOctetSequenceTo(
        ...
        byte[] buf = this.toByteArray(); s.write_long(buf.length);
