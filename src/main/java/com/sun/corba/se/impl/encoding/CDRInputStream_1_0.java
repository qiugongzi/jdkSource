    ...
    implements RestorableInputStream
{
    ...
    public Serializable read_value(BoxedValueHelper factory) {
        ...
        if (vType == 0)
            return null; else if (vType == 0xffffffff) { int indirection = read_long() + get_offset() - 4;
            if (valueCache != null && valueCache.containsVal(indirection))
                {
                    java.io.Serializable cachedValue =
                           (java.io.Serializable)valueCache.getKey(indirection);
            ...
            if (factory instanceof ValueHelper) {
                ...
                valueIndirection = indirection;  value = factory.read_value(parent);
            }
    ...
    private java.lang.Object readIDLValueWithHelper(ValueHelper helper, int indirection)
    {
        ...
        catch(NoSuchMethodException nsme) { java.lang.Object result = helper.read_value(parent);
            return result;
        }
                                          ...
                                          Class clazz, String codebase)
    {
        ...
        valueIndirection = indirection;  return factory.read_value(parent);
    }
    ...
    private final String read_repositoryId()
    {
        ...
        if (result == null) { int indirection = read_long() + get_offset() - 4;
