...
public class POAImpl extends ObjectAdapterBase implements POA
{
    ...
    private static final int STATE_START        = 0 ; private static final int STATE_INIT         = 1 ; private static final int STATE_INIT_DONE    = 2 ; private static final int STATE_RUN          = 3 ; private static final int STATE_DESTROYING   = 4 ; private static final int STATE_DESTROYED    = 5 ; private String stateToString()
    {
        switch (state) {
            case STATE_START :
                return "START" ;
    ...
    private int numLevels;          private ObjectAdapterId poaId ; private String name;            private POAManagerImpl manager; private int uniquePOAId ;       private POAImpl parent;         private Map children;           private AdapterActivator activator;
    private int invocationCount ; Sync poaMutex ;
    ...
    private void initialize( POAManagerImpl manager, Policies policies )
    {
        ...
        boolean objectAdapterCreated = true; initializeTemplate( oktemp, objectAdapterCreated,
                            policies,
                            null, null, oktemp.getObjectAdapterId()
                            ) ;
