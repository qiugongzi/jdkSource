...
public class AnyImpl extends Any
{
    ...
    static boolean isStreamed[] = {
        false,  false,  false,  false,  false,  false,  false,  false,  false,  false,  false,  false,  false,  true,   false,  true,   true,   false,  false,  true,   true,   true,   true,   false,  false,  false,  false,  false,  false,  false,  false,  false,  false   };
    ...
    private TypeCode realType(TypeCode aType) {
        ...
        } catch (BadKind bad) { throw wrapper.badkindCannotOccur( bad ) ;
        }
        return realType;
    }
    ...
    private boolean equalMember(TypeCode memberType, InputStream myStream, InputStream otherStream) {
        ...
        try {
            switch (realType.kind().value()) {
                ...
                case TCKind._tk_sequence: {
                    ...
                    otherStream.read_long(); for (int i=0; i<length; i++) {
        ...
        } catch (BadKind badKind) { throw wrapper.badkindCannotOccur() ;
        } catch (Bounds bounds) { throw wrapper.boundsCannotOccur() ;
        }
    }
