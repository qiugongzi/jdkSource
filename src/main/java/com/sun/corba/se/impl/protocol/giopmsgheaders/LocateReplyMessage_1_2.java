...
public final class LocateReplyMessage_1_2 extends Message_1_2
    ...
    private short addrDisposition = KeyAddr.value; LocateReplyMessage_1_2(ORB orb) {
        this.orb = orb;
    ...
    public void read(org.omg.CORBA.portable.InputStream istream) {
        ...
        isValidReplyStatus(this.reply_status); if (this.reply_status == LOC_SYSTEM_EXCEPTION) {
