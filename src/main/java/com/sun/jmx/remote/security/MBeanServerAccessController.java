...
public abstract class MBeanServerAccessController
    ...
    throws InstanceNotFoundException {
        ...
        if (operation.equals("addURL")) { throw new SecurityException("Access denied! MLet method addURL " +
                    "cannot be invoked unless a security manager is installed.");
        } else { final String propName = "jmx.remote.x.mlet.allow.getMBeansFromURL";
