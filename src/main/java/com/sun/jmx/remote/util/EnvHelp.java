...
public class EnvHelp {
    ...
    public static int getNotifBufferSize(Map<String, ?> env) {
        int defaultQueueSize = 1000; final String oldP = "jmx.remote.x.buffer.size";
        ...
        try {
            ...
            } else { act = new GetPropertyAction(oldP);
        ...
        try {
            if (env.containsKey(BUFFER_SIZE_PROPERTY)) {
                queueSize = (int)EnvHelp.getIntegerAttribute(env,BUFFER_SIZE_PROPERTY,
                                            defaultQueueSize,0,
                                            Integer.MAX_VALUE);
            } else { queueSize = (int)EnvHelp.getIntegerAttribute(env,oldP,
                                            defaultQueueSize,0,
                                            Integer.MAX_VALUE);
            }
        } catch (RuntimeException e) {
