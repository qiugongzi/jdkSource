...
public abstract class CommunicatorServer
    ...
    private void sendStateChangeNotification(int oldState, int newState) {
        ...
        AttributeChangeNotification notif =
            new AttributeChangeNotification(this,    notifCount,                 System.currentTimeMillis(), message,                    "State",                    "int",                      new Integer(oldState),      new Integer(newState) );    if (SNMP_ADAPTOR_LOGGER.isLoggable(Level.FINEST)) {
            SNMP_ADAPTOR_LOGGER.logp(Level.FINEST, dbgTag,
