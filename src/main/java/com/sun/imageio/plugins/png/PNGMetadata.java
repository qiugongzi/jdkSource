...
public class PNGMetadata extends IIOMetadata implements Cloneable {
    ...
    public int IHDR_interlaceMethod; public boolean PLTE_present;
    ...
    public int bKGD_colorType; public int bKGD_index;
    ...
    public int pHYs_unitSpecifier; public boolean sBIT_present;
    public int sBIT_colorType; public int sBIT_grayBits;
    ...
    public String sPLT_paletteName; public int sPLT_sampleDepth; public int[] sPLT_red;
    ...
    public ArrayList<String> tEXt_keyword = new ArrayList<String>(); public ArrayList<String> tEXt_text = new ArrayList<String>();
    ...
    public int tRNS_colorType; public byte[] tRNS_alpha; public int tRNS_gray;
    public int tRNS_red;
        ...
        if (colorModel instanceof IndexColorModel) {
            ...
            if (isGray && hasAlpha && (bitDepth == 8 || bitDepth == 16)) {
                ...
                if (hasAlpha) {
                    ...
                    int len = oldRed.length; PLTE_red = new byte[len];
    ...
    private Node getNativeTree() {
        IIOMetadataNode node = null; IIOMetadataNode root = new IIOMetadataNode(nativeMetadataFormatName);
    ...
    public IIOMetadataNode getStandardChromaNode() {
        ...
        IIOMetadataNode node = null; node = new IIOMetadataNode("ColorSpaceType");
    ...
    public IIOMetadataNode getStandardCompressionNode() {
        ...
        IIOMetadataNode node = null; node = new IIOMetadataNode("CompressionTypeName");
    ...
    public IIOMetadataNode getStandardDataNode() {
        ...
        IIOMetadataNode node = null; node = new IIOMetadataNode("PlanarConfiguration");
        ...
        if (sBIT_present) {
            ...
            } else { sbits = Integer.toString(sBIT_redBits) + " " +
                    Integer.toString(sBIT_greenBits) + " " +
                    Integer.toString(sBIT_blueBits);
            }
    ...
    public IIOMetadataNode getStandardDimensionNode() {
        ...
        IIOMetadataNode node = null; node = new IIOMetadataNode("PixelAspectRatio");
    ...
    public IIOMetadataNode getStandardDocumentNode() {
        ...
        IIOMetadataNode node = null; node = new IIOMetadataNode("ImageModificationTime");
    ...
    public IIOMetadataNode getStandardTextNode() {
        ...
        IIOMetadataNode node = null; for (int i = 0; i < tEXt_keyword.size(); i++) {
    ...
    public IIOMetadataNode getStandardTransparencyNode() {
        ...
        IIOMetadataNode node = null; node = new IIOMetadataNode("Alpha");
        boolean hasAlpha =
            (IHDR_colorType == PNGImageReader.PNG_COLOR_RGB_ALPHA) ||
            (IHDR_colorType == PNGImageReader.PNG_COLOR_GRAY_ALPHA) ||
            (IHDR_colorType == PNGImageReader.PNG_COLOR_PALETTE &&
    ...
    private void mergeNativeTree(Node root)
        ...
        while (node != null) {
            ...
            if (name.equals("IHDR")) {
                ...
                bKGD_present = false; Node bKGD_node = node.getFirstChild();
                if (bKGD_node == null) {
                ...
                sBIT_present = false; Node sBIT_node = node.getFirstChild();
                if (sBIT_node == null) {
                ...
                tRNS_present = false; Node tRNS_node = node.getFirstChild();
                if (tRNS_node == null) {
                ...
                while (child != null) {
                    ...
                    if (childName.equals("TextEntry")) {
                        ...
                        if (!isValidKeyword(keyword)) {
                            ...
                            iTXt_translatedKeyword.add(keyword); iTXt_text.add(value);
                        }
                    }
                    child = child.getNextSibling();
                }
