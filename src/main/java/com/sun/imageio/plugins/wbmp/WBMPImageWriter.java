...
public class WBMPImageWriter extends ImageWriter {
    ...
    public void setOutput(Object output) {
        super.setOutput(output); if (output != null) {
    ...
    public void write(IIOMetadata streamMetadata,
        ...
        stream.write(0); stream.write(0); stream.write(intToMultiByte(w)); stream.write(intToMultiByte(h)); if(!isWhiteZero && lineStride == bytesPerRow) {
