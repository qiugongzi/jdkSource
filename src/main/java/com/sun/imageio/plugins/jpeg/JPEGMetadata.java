...
public class JPEGMetadata extends IIOMetadata implements Cloneable {
    ...
    JPEGMetadata(boolean isStream, boolean inThumb) {
        super(true,  JPEG.nativeImageMetadataFormatName,  JPEG.nativeImageMetadataFormatClassName,
              null, null);  this.inThumb = inThumb;
    ...
    JPEGMetadata(boolean isStream,
        ...
        boolean done = false;
        buffer.bufAvail -=2;  buffer.bufPtr = 2;
        ...
        while (!done) {
            ...
            case JPEG.DRI:
                ...
                break;
            case JPEG.APP0:
                buffer.loadBuf(8); buf = buffer.buf;
                ptr = buffer.bufPtr;
                if ((buf[ptr+3] == 'J')
                    && (buf[ptr+4] == 'F')
                    && (buf[ptr+5] == 'I')
                ...
                break;
            case JPEG.APP2:
                buffer.loadBuf(15); if ((buffer.buf[buffer.bufPtr+3] == 'I')
                ...
                break;
            case JPEG.APP14:
                buffer.loadBuf(8); if ((buffer.buf[buffer.bufPtr+3] == 'A')
    ...
    JPEGMetadata(ImageTypeSpecifier imageType,
        ...
        if (param != null) {
            ...
            if (param instanceof JPEGImageWriteParam) {
                ...
                if (jparam.areTablesSet()) {
                    wantQTables = false;  wantHTables = false;
        ...
        if (destType != null) {
            ...
            case ColorSpace.TYPE_GRAY:
                willSubsample = false;
                if (hasExtraComponents) {  wantJFIF = false;
                }
                break;
            ...
            case ColorSpace.TYPE_YCbCr:
                if (hasExtraComponents) { wantJFIF = false;
                    if (!hasAlpha) { wantAdobe = true;
                        transform = JPEG.ADOBE_YCCK;
                    }
                }
                break;
            case ColorSpace.TYPE_RGB:  wantJFIF = false;
                wantAdobe = true;
                willSubsample = false;
            ...
            case ColorSpace.TYPE_GRAY:
                ...
                break;
            case ColorSpace.TYPE_RGB:  if (hasAlpha) {
                    wantJFIF = false;
                }
                break;
            case ColorSpace.TYPE_3CLR:
        ...
        if (!wantProg) {  markerSequence.add(new SOSMarkerSegment(willSubsample,
                                                    componentIDs,
                                                    numComponents));
        }
    ...
    protected Object clone() {
        ...
        } catch (CloneNotSupportedException e) {} if (markerSequence != null) {
    ...
    IIOMetadataNode getNativeTree() {
        ...
        if (isStream) {
            ...
            if (!inThumb) {
                ...
                if (jfif != null) {
                    iter.next();  header.appendChild(jfif.getNativeNode());
                }
    ...
    protected IIOMetadataNode getStandardChromaNode() {
        hasAlpha = false;  SOFMarkerSegment sof = (SOFMarkerSegment)
    ...
    protected IIOMetadataNode getStandardTransparencyNode() {
        ...
        if (hasAlpha == true) {
            ...
            alpha.setAttribute("value", "nonpremultiplied"); trans.appendChild(alpha);
        }
        return trans;
    }
    ...
    public void mergeTree(String formatName, Node root)
        ...
        if (resetSequence == null) {
            resetSequence = cloneSequence();  copy = resetSequence;  } else {
            copy = cloneSequence();
        }
        if (isStream &&
    ...
    private void mergeNativeTree(Node root) throws IIOInvalidTreeException {
        ...
        if (root.getChildNodes().getLength() != 2) { throw new IIOInvalidTreeException(
    ...
    private void insertCOMMarkerSegment(COMMarkerSegment newGuy) {
        ...
        if (lastCOM != -1) {
            ...
            markerSequence.add(1, newGuy);  } else if (firstAdobe != -1) {
    ...
    private void insertAdobeMarkerSegment(AdobeMarkerSegment newGuy) {
        ...
        if (hasJFIF) {
            markerSequence.add(1, newGuy);  } else if (lastUnknown != -1) {
    ...
    private void mergeUnknownNode(Node node) throws IIOInvalidTreeException {
        ...
        if (lastUnknown != -1) {
            ...
            markerSequence.add(1, newGuy);  } if (firstAdobe != -1) {
    ...
    private void mergeStandardChromaNode(Node node, NodeList siblings)
        ...
        byte [] ids = {1, 2, 3, 4};  if (csName.equals("GRAY")) {
            numChannels = 1;
            wantJFIF = true;
        ...
        if ((sof != null) && (sof.tag == JPEG.SOF2)) { if ((sof.componentSpecs.length != numChannels) && (sos != null)) {
                return;
            }
        }
    ...
    private boolean wantAlpha(Node transparency) {
        ...
        Node alpha = transparency.getFirstChild();  if (alpha.getNodeName().equals("Alpha")) {
        ...
        if (jfif == null) {
            ...
            if (sof != null) {
                ...
                if ((numChannels == 1) || (numChannels == 3)) {
                    canHaveJFIF = true; for (int i = 0; i < sof.componentSpecs.length; i++) {
    ...
    private void mergeStandardTransparencyNode(Node node)
        ...
        if (!transparencyDone && !isStream) {
            ...
            if ((sof != null) && (sof.tag == JPEG.SOF2)) { return;
            }
    ...
    private boolean isConsistent() {
        ...
        if (!isStream) {
            if (sof != null) {
                ...
                if (numScanBands != 0) {  if (numScanBands != numSOFBands) {
                        retval = false;
                    }
                }
                if (jfif != null) {
    ...
    public void reset() {
        if (resetSequence != null) {  markerSequence = resetSequence;
            resetSequence = null;
        }
    }
