...
public class BMPImageReader extends ImageReader implements BMPConstants {
    ...
    public void setInput(Object input,
        ...
        iis = (ImageInputStream) input; if(iis != null)
    ...
    protected void readHeader() throws IOException, IllegalArgumentException {
        ...
        if (size == 12) {
            ...
            if (size == 40) {
                ...
                case BI_RGB:  case BI_RLE8:  case BI_RLE4:  if (bitmapOffset < (size + 14)) {
                    ...
                    if (bitsPerPixel == 1) {
                        ...
                        redMask = 0x7C00;
                        greenMask = 0x3E0;
                        blueMask =  (1 << 5) - 1;metadata.redMask = redMask;
    ...
    public BufferedImage read(int imageIndex, ImageReadParam param)
        ...
        byte bdata[] = null; short sdata[] = null; int idata[] = null; if (sampleModel != null) {
