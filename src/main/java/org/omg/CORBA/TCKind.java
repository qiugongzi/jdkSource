...
public class TCKind {
    ...
    public static final int _tk_value = 29;             public static final int _tk_value_box = 30; public static final int _tk_native = 31;        public static final int _tk_abstract_interface = 32;
