...
public interface SOAPConstants {
    ...
    public static final String
                URI_NS_SOAP_1_1_ENVELOPE = "http:public static final String
                URI_NS_SOAP_1_2_ENVELOPE = "http:public static final String
        URI_NS_SOAP_ENVELOPE = URI_NS_SOAP_1_1_ENVELOPE;


    public static final String
        URI_NS_SOAP_ENCODING = "http:public static final String
        URI_NS_SOAP_1_2_ENCODING = "http:public static final String
    ...
    public static final String
        URI_SOAP_ACTOR_NEXT = "http:public static final String
