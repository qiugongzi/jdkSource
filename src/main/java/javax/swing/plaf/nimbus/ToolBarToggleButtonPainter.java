...
final class ToolBarToggleButtonPainter extends AbstractRegionPainter {
    ...
    private RoundRectangle2D decodeRoundRect1() {
        roundRect.setRoundRect(decodeX(0.4f), decodeY(0.6f), decodeX(2.6f) - decodeX(0.4f), decodeY(2.6f) - decodeY(0.6f), 12.0f, 12.0f); return roundRect;
    }

    private RoundRectangle2D decodeRoundRect2() {
        roundRect.setRoundRect(decodeX(0.4f), decodeY(0.4f), decodeX(2.6f) - decodeX(0.4f), decodeY(2.4f) - decodeY(0.4f), 12.0f, 12.0f); return roundRect;
    }

    private RoundRectangle2D decodeRoundRect3() {
        roundRect.setRoundRect(decodeX(0.6f), decodeY(0.6f), decodeX(2.4f) - decodeX(0.6f), decodeY(2.2f) - decodeY(0.6f), 9.0f, 9.0f); return roundRect;
    }

    private RoundRectangle2D decodeRoundRect4() {
        roundRect.setRoundRect(decodeX(0.120000005f), decodeY(0.120000005f), decodeX(2.8800004f) - decodeX(0.120000005f), decodeY(2.6800003f) - decodeY(0.120000005f), 13.0f, 13.0f); return roundRect;
    }

    private RoundRectangle2D decodeRoundRect5() {
        roundRect.setRoundRect(decodeX(0.4f), decodeY(0.6f), decodeX(2.6f) - decodeX(0.4f), decodeY(2.6f) - decodeY(0.6f), 10.0f, 10.0f); return roundRect;
    }

    private RoundRectangle2D decodeRoundRect6() {
        roundRect.setRoundRect(decodeX(0.4f), decodeY(0.4f), decodeX(2.6f) - decodeX(0.4f), decodeY(2.4f) - decodeY(0.4f), 10.0f, 10.0f); return roundRect;
    }

    private RoundRectangle2D decodeRoundRect7() {
        roundRect.setRoundRect(decodeX(0.6f), decodeY(0.6f), decodeX(2.4f) - decodeX(0.6f), decodeY(2.2f) - decodeY(0.6f), 8.0f, 8.0f); return roundRect;
    }

    private RoundRectangle2D decodeRoundRect8() {
        roundRect.setRoundRect(decodeX(0.120000005f), decodeY(0.120000005f), decodeX(2.8800004f) - decodeX(0.120000005f), decodeY(2.6799998f) - decodeY(0.120000005f), 13.0f, 13.0f); return roundRect;
    }
