...
final class InternalFramePainter extends AbstractRegionPainter {
    ...
    private RoundRectangle2D decodeRoundRect1() {
        roundRect.setRoundRect(decodeX(0.0f), decodeY(0.0f), decodeX(3.0f) - decodeX(0.0f), decodeY(3.0f) - decodeY(0.0f), 4.6666665f, 4.6666665f); return roundRect;
    }
    ...
    private Rectangle2D decodeRect2() {
            rect.setRect(decodeX(0.33333334f), decodeY(2.6666667f), decodeX(2.6666667f) - decodeX(0.33333334f), decodeY(2.8333333f) - decodeY(2.6666667f)); return rect;
    }

    private RoundRectangle2D decodeRoundRect2() {
        roundRect.setRoundRect(decodeX(0.0f), decodeY(0.0f), decodeX(3.0f) - decodeX(0.0f), decodeY(3.0f) - decodeY(0.0f), 4.8333335f, 4.8333335f); return roundRect;
    }
    ...
    private Rectangle2D decodeRect3() {
            rect.setRect(decodeX(0.0f), decodeY(0.0f), decodeX(0.0f) - decodeX(0.0f), decodeY(0.0f) - decodeY(0.0f)); return rect;
    }

    private Rectangle2D decodeRect4() {
            rect.setRect(decodeX(0.33333334f), decodeY(0.08f), decodeX(2.6666667f) - decodeX(0.33333334f), decodeY(0.96f) - decodeY(0.08f)); return rect;
    }
