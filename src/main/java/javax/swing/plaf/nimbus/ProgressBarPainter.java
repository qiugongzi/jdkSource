...
final class ProgressBarPainter extends AbstractRegionPainter {
    ...
    private Rectangle2D decodeRect2() {
            rect.setRect(decodeX(0.6f), decodeY(0.6f), decodeX(2.4f) - decodeX(0.6f), decodeY(2.4f) - decodeY(0.6f)); return rect;
    }
    ...
    private Rectangle2D decodeRect3() {
            rect.setRect(decodeX(0.6666667f), decodeY(0.6666667f), decodeX(3.0f) - decodeX(0.6666667f), decodeY(2.3333333f) - decodeY(0.6666667f)); return rect;
    }

    private Rectangle2D decodeRect4() {
            rect.setRect(decodeX(1.0f), decodeY(1.0f), decodeX(2.6666667f) - decodeX(1.0f), decodeY(2.0f) - decodeY(1.0f)); return rect;
    }
    ...
    private Rectangle2D decodeRect5() {
            rect.setRect(decodeX(0.6666667f), decodeY(0.6666667f), decodeX(2.3333333f) - decodeX(0.6666667f), decodeY(2.3333333f) - decodeY(0.6666667f)); return rect;
    }
    ...
    private Rectangle2D decodeRect8() {
            rect.setRect(decodeX(1.2916666f), decodeY(0.0f), decodeX(1.3333334f) - decodeX(1.2916666f), decodeY(3.0f) - decodeY(0.0f)); return rect;
    }

    private Rectangle2D decodeRect9() {
            rect.setRect(decodeX(1.7083333f), decodeY(0.0f), decodeX(1.75f) - decodeX(1.7083333f), decodeY(3.0f) - decodeY(0.0f)); return rect;
    }
