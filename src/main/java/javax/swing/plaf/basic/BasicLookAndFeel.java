    ...
    protected void initComponentDefaults(UIDefaults table)
    {
       ...
       "shift ctrl alt F6", "selectPreviousFrame",
          ...
          "shift ctrl F12", "navigatePrevious"
            ...
            "OptionPane.informationSound", null, "OptionPane.questionSound", null,
           ...
           "Separator.shadow", controlShadow,          "Separator.highlight", controlLtHighlight,  "Separator.background", controlLtHighlight,
            ...
            "Table.foreground", controlText,  "Table.background", window,  "Table.selectionForeground", textHighlightText,
            "Table.selectionBackground", textHighlight,
            "Table.dropLineColor", controlShadow,
            "Table.dropLineShortColor", black,
            "Table.gridColor", gray,  "Table.focusCellBackground", window,
            ...
            "TableHeader.foreground", controlText, "TableHeader.background", control, "TableHeader.cellBorder", tableHeaderBorder,

            "TableHeader.focusCellBackground", table.getColor("text"), "TableHeader.focusCellForeground", null,
