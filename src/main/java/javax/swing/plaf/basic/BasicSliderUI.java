...
public class BasicSliderUI extends SliderUI{
    ...
    public int getBaseline(JComponent c, int width, int height) {
        ...
        if (slider.getPaintLabels() && labelsHaveSameBaselines()) {
            ...
            else { boolean inverted = slider.getInverted();
    ...
    protected void calculateTrackRect() {
        int centerSpacing; if ( slider.getOrientation() == JSlider.HORIZONTAL ) {
    ...
    public void paintThumb(Graphics g)  {
        ...
        if ((!slider.getPaintTicks() && paintThumbArrowShape == null) ||
            ...
            if(BasicGraphicsUtils.isLeftToRight(slider)) {
                  ...
                  g.setColor(highlightColor);
                  g.drawLine(0, 0, 0, h - 2);                  g.drawLine(1, 0, w-1-cw, 0);                 g.drawLine(w-cw-1, 0, w-1, cw);              g.setColor(Color.black);
                  g.drawLine(0, h-1, w-2-cw, h-1);             g.drawLine(w-1-cw, h-1, w-1, h-1-cw);        g.setColor(shadowColor);
                  g.drawLine(1, h-2, w-2-cw,  h-2 );         g.drawLine(w-1-cw, h-2, w-2, h-cw-1 );     }
            else {
                  ...
                  g.setColor(highlightColor);
                  g.drawLine(cw-1, 0, w-2, 0);             g.drawLine(0, cw, cw, 0);                g.setColor(Color.black);
                  g.drawLine(0, h-1-cw, cw, h-1 );         g.drawLine(cw, h-1, w-1, h-1);           g.setColor(shadowColor);
                  g.drawLine(cw, h-2, w-2,  h-2 );         g.drawLine(w-1, 1, w-1,  h-2 );          }
        }
