...
public class BasicProgressBarUI extends ProgressBarUI {
    ...
    private int numFrames;   private int repaintInterval;


    private int cycleTime;  private static boolean ADJUSTTIMER = true; protected Rectangle boxRect;


    private Rectangle nextPaintRect;

    private Rectangle componentInnards;    private Rectangle oldComponentInnards; private double delta = 0.0;

    private int maxPosition = 0; public static ComponentUI createUI(JComponent x) {
    ...
    private void updateSizes() {
        ...
        } else { length = getBoxLength(componentInnards.height,
    ...
    private Rectangle getGenericBox(Rectangle r) {
        ...
        if (progressBar.getOrientation() == JProgressBar.HORIZONTAL) {
          ...
          } else { r.height = getBoxLength(componentInnards.height,
                                    componentInnards.width);
            if (r.height < 0) {
                r = null;
            } else {
    ...
    protected void paintIndeterminate(Graphics g, JComponent c) {
        ...
        Insets b = progressBar.getInsets(); int barRectWidth = progressBar.getWidth() - (b.right + b.left);
    ...
    protected void paintDeterminate(Graphics g, JComponent c) {
        ...
        } else { if (cellSpacing == 0 && amountFull > 0) {
    ...
    private void paintString(Graphics g, int x, int y, int width, int height,
        ...
        if (progressBar.getOrientation() == JProgressBar.HORIZONTAL) {
            ...
            SwingUtilities2.drawString(progressBar, g2, progressString,
                                       renderLocation.x, renderLocation.y);
        } else { g2.setColor(getSelectionBackground());
    ...
    protected Point getStringPlacement(Graphics g, String progressString,
        ...
        } else { return new Point(x + ((width - fontSizer.getAscent() +
    ...
    protected void setAnimationIndex(int newValue) {
        if (animationIndex != newValue) {
            if (sizeChanged()) {
                ...
                maxPosition = 0;  delta = 0.0;      progressBar.repaint();
                return;
            }
    ...
    private void initIndeterminateDefaults() {
        initRepaintInterval(); initCycleTime();       if (repaintInterval <= 0) {
            repaintInterval = 100;
        }
    ...
    private class Animator implements ActionListener {
        private Timer timer;
        private long previousDelay; private int interval; private long lastCall; private int MINIMUM_DELAY = 5;
        ...
        public void actionPerformed(ActionEvent e) {
            if (ADJUSTTIMER) {
                ...
                if (lastCall > 0) { int nextDelay = (int)(previousDelay
                                          - time + lastCall
                                          + getRepaintInterval());
