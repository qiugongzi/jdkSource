...
public class SynthSliderUI extends BasicSliderUI
    ...
    private transient boolean thumbActive; private transient boolean thumbPressed; public static ComponentUI createUI(JComponent c) {
    ...
    public int getBaseline(JComponent c, int width, int height) {
        ...
        if (slider.getPaintLabels() && labelsHaveSameBaselines()) {
            ...
            else { Integer value = slider.getInverted() ? getLowestValue() :
                                                       getHighestValue();
                if (value != null) {
