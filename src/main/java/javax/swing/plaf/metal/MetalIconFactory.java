...
public class MetalIconFactory implements Serializable {
    ...
    private static class FileChooserDetailViewIcon implements Icon, UIResource, Serializable {
        public void paintIcon(Component c, Graphics g, int x, int y) {
            ...
            g.drawLine(2,2, 5,2); g.drawLine(2,3, 2,7); g.drawLine(3,7, 6,7); g.drawLine(6,6, 6,3); g.drawLine(2,10, 5,10); g.drawLine(2,11, 2,15); g.drawLine(3,15, 6,15); g.drawLine(6,14, 6,11); g.drawLine(8,5, 15,5);     g.drawLine(8,13, 15,13);   g.setColor(MetalLookAndFeel.getPrimaryControl());
            g.drawRect(3,3, 2,3);   g.drawRect(3,11, 2,3);  g.setColor(MetalLookAndFeel.getPrimaryControlHighlight());
            g.drawLine(4,4, 4,5);     g.drawLine(4,12, 4,13);   g.translate(-x, -y);
        }
        ...
        public void paintIcon(Component c, Graphics g, int x, int y) {
            ...
            g.setColor(MetalLookAndFeel.getPrimaryControlInfo());
            g.drawLine(8,1, 1,8);  g.drawLine(8,1, 15,8); g.drawLine(11,2, 11,3); g.drawLine(12,2, 12,4); g.drawLine(3,7, 3,15); g.drawLine(13,7, 13,15); g.drawLine(4,15, 12,15); g.drawLine( 6,9,  6,14); g.drawLine(10,9, 10,14); g.drawLine( 7,9,  9, 9); g.setColor(MetalLookAndFeel.getControlDarkShadow());
            g.fillRect(8,2, 1,1); g.fillRect(7,3, 3,1);
            g.fillRect(6,4, 5,1);
            g.fillRect(5,5, 7,1);
            g.fillRect(4,6, 9,2);
            ...
            g.drawLine(4,8, 12,8); g.fillRect(4,9, 2,6); g.fillRect(11,9, 2,6); g.translate(-x, -y);
        }
        ...
        public void paintIcon(Component c, Graphics g, int x, int y) {
            ...
            g.setColor(MetalLookAndFeel.getPrimaryControlInfo());
            g.drawLine(2,2, 5,2); g.drawLine(2,3, 2,7); g.drawLine(3,7, 6,7); g.drawLine(6,6, 6,3); g.drawLine(10,2, 13,2); g.drawLine(10,3, 10,7); g.drawLine(11,7, 14,7); g.drawLine(14,6, 14,3); g.drawLine(2,10, 5,10); g.drawLine(2,11, 2,15); g.drawLine(3,15, 6,15); g.drawLine(6,14, 6,11); g.drawLine(10,10, 13,10); g.drawLine(10,11, 10,15); g.drawLine(11,15, 14,15); g.drawLine(14,14, 14,11); g.drawLine(8,5, 8,5);     g.drawLine(16,5, 16,5);   g.drawLine(8,13, 8,13);   g.drawLine(16,13, 16,13); g.setColor(MetalLookAndFeel.getPrimaryControl());
            g.drawRect(3,3, 2,3);   g.drawRect(11,3, 2,3);  g.drawRect(3,11, 2,3);  g.drawRect(11,11, 2,3); g.setColor(MetalLookAndFeel.getPrimaryControlHighlight());
            g.drawLine(4,4, 4,5);     g.drawLine(12,4, 12,5);   g.drawLine(4,12, 4,13);   g.drawLine(12,12, 12,13); g.translate(-x, -y);
        }
        ...
        public void paintIcon(Component c, Graphics g, int x, int y) {
            ...
            g.setColor(MetalLookAndFeel.getPrimaryControlInfo());
            g.drawLine(1,6,    1,14); g.drawLine(2,14,  15,14); g.drawLine(15,13, 15,5);  g.drawLine(2,5,    9,5);  g.drawLine(10,6,  14,6);  g.setColor(MetalLookAndFeel.getPrimaryControlHighlight());
            g.drawLine( 2,6,  2,13); g.drawLine( 3,6,  9,6);  g.drawLine(10,7, 14,7);  g.setColor(MetalLookAndFeel.getPrimaryControlDarkShadow());
            g.drawLine(11,3, 15,3); g.drawLine(10,4, 15,4); g.translate(-x, -y);
        }
        ...
        public void paintIcon(Component c, Graphics g, int x, int y) {
            ...
            g.setColor(MetalLookAndFeel.getPrimaryControlInfo());
            g.drawLine(1,6,    1,14); g.drawLine(2,14,  15,14); g.drawLine(15,13, 15,5);  g.drawLine(2,5,    9,5);  g.drawLine(10,6,  14,6);  g.drawLine(8,13,  8,16); g.drawLine(8, 9,  8, 9); g.drawLine(7,10,  9,10);
    ...
    private static class InternalFrameCloseIcon implements Icon, UIResource, Serializable {
        ...
        public void paintIcon(Component c, Graphics g, int x, int y) {
            ...
            int oneHalf = iconSize / 2; g.translate(x, y);
            ...
            g.drawLine(3,iconSize-3, 3,iconSize-3); g.drawLine(iconSize-3,3, iconSize-3,3); g.setColor(darkHighlightColor);
            g.drawLine(4,5, 5,4); g.drawLine(4,iconSize-6, iconSize-6,4); g.setColor(xLightHighlightColor);
            g.drawLine(6,iconSize-5, iconSize-5,6); g.drawLine(oneHalf,oneHalf+2, oneHalf+2,oneHalf);
              g.drawLine(iconSize-5,iconSize-5, iconSize-4,iconSize-5);
            g.drawLine(iconSize-5,iconSize-4, iconSize-5,iconSize-4);
            g.setColor(mainItemColor);
              g.drawLine(5,5, iconSize-6,iconSize-6); g.drawLine(6,5, iconSize-5,iconSize-6); g.drawLine(5,6, iconSize-6,iconSize-5); g.drawLine(5,iconSize-5, iconSize-5,5); g.drawLine(5,iconSize-6, iconSize-6,5); g.translate(-x, -y);
        }
        ...
        public void paintIcon(Component c, Graphics g, int x, int y) {
            ...
            g.drawLine(1,iconSize-2, 1,iconSize-2); g.setColor(lrLightHighlightColor);
            ...
            g.setColor(mainItemColor);
            g.fillRect(iconSize-7,3, 3,5); g.drawLine(iconSize-6,5, iconSize-3,2); g.drawLine(iconSize-6,6, iconSize-2,2); g.drawLine(iconSize-6,7, iconSize-3,7); g.setColor(darkHighlightColor);
            g.drawLine(iconSize-8,2, iconSize-7,2); g.drawLine(iconSize-8,3, iconSize-8,7); g.drawLine(iconSize-6,4, iconSize-3,1); g.drawLine(iconSize-4,6, iconSize-3,6); g.setColor(lrLightHighlightColor);
            g.drawLine(iconSize-6,3, iconSize-6,3); g.drawLine(iconSize-4,5, iconSize-2,3); g.drawLine(iconSize-4,8, iconSize-3,8); g.drawLine(iconSize-2,8, iconSize-2,7); g.translate(-x, -y);
        }
        ...
        public void paintIcon(Component c, Graphics g, int x, int y) {
            ...
            g.drawRect(1,1, 13,13); g.drawLine(1,0, 14,0); g.drawLine(15,1, 15,14); g.drawLine(1,15, 14,15); g.drawLine(0,1, 0,14); g.drawLine(2,5, 13,5); g.drawLine(3,3, 3,3);
            g.drawLine(6,3, 6,3);
            g.drawLine(9,3, 9,3);
        ...
        public void paintIcon(Component c, Graphics g, int x, int y) {
            ...
            g.setColor(ulLightHighlightColor);
            g.drawRect(3,7, iconSize-10,iconSize-10); g.setColor(lrLightHighlightColor);
            g.drawRect(2,6, iconSize-7,iconSize-7); g.setColor(darkHighlightColor);
            g.drawRect(1,5, iconSize-7,iconSize-7); g.drawRect(2,6, iconSize-9,iconSize-9); g.setColor(mainItemColor);
            g.drawRect(2,6, iconSize-8,iconSize-8); g.setColor(darkHighlightColor);
            ...
            g.drawLine(iconSize-6,3, iconSize-4,5); g.drawLine(iconSize-4,5, iconSize-4,6); g.drawLine(iconSize-2,7, iconSize-1,7); g.drawLine(iconSize-1,2, iconSize-1,6); g.setColor(mainItemColor);
            g.drawLine(3,iconSize-4, iconSize-3,2); g.drawLine(3,iconSize-3, iconSize-2,2); g.drawLine(4,iconSize-3, 5,iconSize-3); g.drawLine(iconSize-7,8, iconSize-7,9); g.drawLine(iconSize-6,2, iconSize-4,2); g.drawRect(iconSize-3,3, 1,3); g.translate(-x, -y);
        }
        ...
        public void paintIcon(Component c, Graphics g, int x, int y) {
            ...
            g.setColor(lrLightHighlightColor);
            g.drawRect(2,10, iconSize-10,iconSize-11); g.setColor(ulLightHighlightColor);
            g.drawRect(3,10, iconSize-12,iconSize-12); g.setColor(darkHighlightColor);
            g.drawRect(1,8, iconSize-10,iconSize-10); g.drawRect(2,9, iconSize-12,iconSize-12); g.setColor(mainItemColor);
            g.drawRect(2,9, iconSize-11,iconSize-11);
            g.drawLine(iconSize-10,10, iconSize-10,10); g.drawLine(3,iconSize-3, 3,iconSize-3); g.setColor(mainItemColor);
            g.fillRect(iconSize-7,3, 3,5); g.drawLine(iconSize-6,5, iconSize-3,2); g.drawLine(iconSize-6,6, iconSize-2,2); g.drawLine(iconSize-6,7, iconSize-3,7); g.setColor(darkHighlightColor);
            g.drawLine(iconSize-8,2, iconSize-7,2); g.drawLine(iconSize-8,3, iconSize-8,7); g.drawLine(iconSize-6,4, iconSize-3,1); g.drawLine(iconSize-4,6, iconSize-3,6); g.setColor(lrLightHighlightColor);
            g.drawLine(iconSize-6,3, iconSize-6,3); g.drawLine(iconSize-4,5, iconSize-2,3); g.drawLine(iconSize-7,8, iconSize-3,8); g.drawLine(iconSize-2,8, iconSize-2,7); g.translate(-x, -y);
        }
        ...
        public void paintIcon(Component c, Graphics g, int x, int y) {
            ...
            g.setColor(MetalLookAndFeel.getPrimaryControlInfo());
            g.drawLine( 2,2,  2,8); g.drawLine(13,2, 13,8); g.drawLine( 3,1, 12,1); g.drawLine(12,9, 12,9); g.drawLine( 3,9,  3,9); g.drawLine( 4,4,  4,7); g.drawLine( 5,3, 10,3); g.drawLine(11,4, 11,7); g.drawLine( 5,8, 10,8); g.drawLine( 1,10, 14,10); g.drawLine(14,10, 14,14); g.drawLine( 1,14, 14,14); g.drawLine( 1,10,  1,14); g.setColor(MetalLookAndFeel.getControlDarkShadow());
            g.drawLine( 6,12,  8,12); g.drawLine(10,12, 12,12); g.translate(-x, -y);
        }
        ...
        public void paintIcon(Component c, Graphics g, int x, int y) {
            ...
            g.setColor(MetalLookAndFeel.getPrimaryControlInfo());
            g.drawLine(1,4, 1,5); g.drawLine(2,3, 3,3);
            g.drawLine(4,2, 11,2); g.drawLine(12,3, 13,3);
            g.drawLine(14,4, 14,5); g.drawLine(12,6, 13,6);
            g.drawLine(4,7, 11,7); g.drawLine(2,6, 3,6);
            g.drawLine(1,7, 1,8); g.drawLine(2,9, 3,9);
            g.drawLine(4,10, 11,10); g.drawLine(12,9, 13,9);
            g.drawLine(14,7, 14, 8); g.drawLine(1,10, 1,11); g.drawLine(2,12, 3,12);
            g.drawLine(4,13, 11,13); g.drawLine(12,12, 13,12);
            g.drawLine(14,10, 14,11); g.setColor(MetalLookAndFeel.getControlShadow());
            g.drawLine(7,6, 7,6);
            g.drawLine(9,6, 9,6);
        ...
        public void paintIcon(Component c, Graphics g, int x, int y) {
            ...
            g.setColor(MetalLookAndFeel.getPrimaryControlInfo());
            g.drawLine( 1, 1, 13, 1); g.drawLine(14, 2, 14,14); g.drawLine( 1,14, 14,14); g.drawLine( 1, 1,  1,14); g.setColor(MetalLookAndFeel.getControlDarkShadow());
            g.fillRect(5,2, 6,5); g.drawLine(4,8, 11,8); g.drawLine(3,9, 3,13); g.drawLine(12,9, 12,13); g.setColor(MetalLookAndFeel.getPrimaryControlHighlight());
            g.fillRect(8,3, 2,3); g.fillRect(4,9, 8,5); g.setColor(MetalLookAndFeel.getPrimaryControlShadow());
    ...
    public static class FolderIcon16 implements Icon, Serializable {
        ...
        private void paintMe(Component c, Graphics g) {
            ...
            g.setColor( MetalLookAndFeel.getPrimaryControlInfo() );
            g.drawLine( 0, 6, 0, bottom );            g.drawLine( 1, 5, right - 7, 5 );         g.drawLine( right - 6, 6, right - 1, 6 ); g.drawLine( right, 5, right, bottom );    g.drawLine( 0, bottom, right, bottom );   g.setColor( MetalLookAndFeel.getPrimaryControlHighlight() );
    ...
    public static class FileIcon16 implements Icon, Serializable {
        ...
        private void paintMe(Component c, Graphics g) {
                ...
                g.setColor( MetalLookAndFeel.getPrimaryControlInfo() );
                g.drawLine( 2, 0, 2, bottom );                 g.drawLine( 2, 0, right - 4, 0 );              g.drawLine( 2, bottom, right - 1, bottom );    g.drawLine( right - 1, 6, right - 1, bottom ); g.drawLine( right - 6, 2, right - 2, 6 );      g.drawLine( right - 5, 1, right - 4, 1 );      g.drawLine( right - 3, 2, right - 3, 3 );      g.drawLine( right - 2, 4, right - 2, 5 );      g.setColor( MetalLookAndFeel.getPrimaryControl() );
                g.drawLine( 3, 1, 3, bottom - 1 );                  g.drawLine( 3, 1, right - 6, 1 );                   g.drawLine( right - 2, 7, right - 2, bottom - 1 );  g.drawLine( right - 5, 2, right - 3, 4 );           g.drawLine( 3, bottom - 1, right - 2, bottom - 1 ); }
    ...
    public static class TreeControlIcon implements Icon, Serializable {
        ...
        public void paintIcon(Component c, Graphics g, int x, int y) {
            ...
            if (MetalUtils.isLeftToRight(c)) {
                if (isLight) {    g.drawImage(image, x+5, y+3, x+18, y+13,
                                       4,3, 17, 13, null);
                }
                else {
                ...
                if (isLight) {    g.drawImage(image, x+3, y+3, x+16, y+13,
                                       4, 3, 17, 13, null);
                }
                else {
        ...
        public void paintMe(Component c, Graphics g, int x, int y) {
            ...
            g.drawLine( xoff + 4, 6, xoff + 4, 9 );     g.drawLine( xoff + 5, 5, xoff + 5, 5 );     g.drawLine( xoff + 6, 4, xoff + 9, 4 );     g.drawLine( xoff + 10, 5, xoff + 10, 5 );   g.drawLine( xoff + 11, 6, xoff + 11, 9 );   g.drawLine( xoff + 10, 10, xoff + 10, 10 ); g.drawLine( xoff + 6, 11, xoff + 9, 11 );   g.drawLine( xoff + 5, 10, xoff + 5, 10 );   g.drawLine( xoff + 7, 7, xoff + 8, 7 );
            g.drawLine( xoff + 7, 8, xoff + 8, 8 );

            if ( isLight ) {    if( MetalUtils.isLeftToRight(c) ) {
            ...
            g.setColor( MetalLookAndFeel.getPrimaryControlDarkShadow() );
            g.drawLine( xoff + 5, 6, xoff + 5, 9 );      g.drawLine( xoff + 6, 5, xoff + 9, 5 );      g.setColor( MetalLookAndFeel.getPrimaryControlShadow() );
            g.drawLine( xoff + 6, 6, xoff + 6, 6 );      g.drawLine( xoff + 9, 6, xoff + 9, 6 );      g.drawLine( xoff + 6, 9, xoff + 6, 9 );      g.drawLine( xoff + 10, 6, xoff + 10, 9 );    g.drawLine( xoff + 6, 10, xoff + 9, 10 );    g.setColor( MetalLookAndFeel.getPrimaryControl() );
            g.drawLine( xoff + 6, 7, xoff + 6, 8 );      g.drawLine( xoff + 7, 6, xoff + 8, 6 );      g.drawLine( xoff + 9, 7, xoff + 9, 7 );      g.drawLine( xoff + 7, 9, xoff + 7, 9 );      g.setColor( MetalLookAndFeel.getPrimaryControlHighlight() );
  ...
  static private final Dimension menuArrowIconSize = new Dimension( 4, 8 );
    ...
    public void paintIcon( Component c, Graphics g, int x, int y ) {
        ...
        if (leftToRight) {
            g.drawLine(  1,0  ,  8,0  ); g.drawLine(  0,1  ,  0,13 ); g.drawLine(  1,14 ,  8,14 ); g.drawLine(  9,1  , 15,7  ); g.drawLine(  9,13 , 15,7  ); }
        else {
            g.drawLine(  7,0  , 14,0  ); g.drawLine( 15,1  , 15,13 ); g.drawLine(  7,14 , 14,14 ); g.drawLine(  0,7  ,  6,1  ); g.drawLine(  0,7  ,  6,13 ); }
        ...
        if ( c.isEnabled() ) {
            ...
            if (leftToRight) {
                ...
                g.drawLine(  8,1  , 14,1  ); g.drawLine(  1,7  ,  7,1  ); }
        }
...
private static class HorizontalSliderThumbIcon implements Icon, Serializable, UIResource {
    ...
    public void paintIcon( Component c, Graphics g, int x, int y ) {
        ...
        g.drawLine(  1,0  , 13,0 );  g.drawLine(  0,1  ,  0,8 );  g.drawLine( 14,1  , 14,8 );  g.drawLine(  1,9  ,  7,15 ); g.drawLine(  7,15 , 14,8 );  if ( c.hasFocus() ) {
            g.setColor( c.getForeground() );
        }
        else {
            g.setColor( MetalLookAndFeel.getControl() );
    ...
    private static class OceanVerticalSliderThumbIcon extends CachedPainter
        ...
        protected void paintToImage(Component c, Image image, Graphics g2,
            ...
            if (hasFocus && enabled) {
                g.setColor(MetalLookAndFeel.getPrimaryControl());
                if (leftToRight) {
                    g.drawLine(  1,1  ,  8,1  ); g.drawLine(  1,1  ,  1,13 ); g.drawLine(  1,13 ,  8,13 ); g.drawLine(  9,2  , 14,7  ); g.drawLine(  9,12 , 14,7  ); }
                else {
                    g.drawLine(  7,1  , 14,1  ); g.drawLine( 14,1  , 14,13 ); g.drawLine(  7,13 , 14,13 ); g.drawLine(  1,7  ,  7,1  ); g.drawLine(  1,7  ,  7,13 ); }
            }
        }
    ...
    private static class OceanHorizontalSliderThumbIcon extends CachedPainter
        ...
        protected void paintToImage(Component c, Image image, Graphics g2,
            ...
            g.drawLine(  1,0  , 13,0 );  g.drawLine(  0,1  ,  0,8 );  g.drawLine( 14,1  , 14,8 );  g.drawLine(  1,9  ,  7,15 ); g.drawLine(  7,15 , 14,8 );  if (hasFocus && enabled) {
                g.setColor(MetalLookAndFeel.getPrimaryControl());
                g.fillRect(1, 1, 13, 1);
                g.fillRect(1, 2, 1, 7);
                g.fillRect(13, 2, 1, 7);
