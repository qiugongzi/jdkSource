...
public class MetalTabbedPaneUI extends BasicTabbedPaneUI {
    ...
    protected boolean shouldFillGap( int currentRun, int tabIndex, int x, int y ) {
        ...
        if ( currentRun == runCount - 2 ) {  Rectangle lastTabBounds = getTabBounds( tabPane, tabPane.getTabCount() - 1 );
    ...
    protected void paintFocusIndicator(Graphics g, int tabPlacement,
        ...
        if ( tabPane.hasFocus() && isSelected ) {
            ...
            switch ( tabPlacement ) {
            case RIGHT:
                g.drawLine( right - 6,2 , right - 2,6 );         g.drawLine( 1,2 , right - 6,2 );                 g.drawLine( right - 2,6 , right - 2,bottom );    g.drawLine( 1,2 , 1,bottom );                    g.drawLine( 1,bottom , right - 2,bottom );       break;
            case BOTTOM:
                if ( leftToRight ) {
                    g.drawLine( 2, bottom - 6, 6, bottom - 2 );   g.drawLine( 6, bottom - 2,
                                right, bottom - 2 );              g.drawLine( 2, 0, 2, bottom - 6 );            g.drawLine( 2, 0, right, 0 );                 g.drawLine( right, 0, right, bottom - 2 );    } else {
                    g.drawLine( right - 2, bottom - 6,
                                right - 6, bottom - 2 );          g.drawLine( right - 2, 0,
                                right - 2, bottom - 6 );          if ( lastInRun ) {
                        g.drawLine( 2, bottom - 2,
                                    right - 6, bottom - 2 );      g.drawLine( 2, 0, right - 2, 0 );         g.drawLine( 2, 0, 2, bottom - 2 );        } else {
                        g.drawLine( 1, bottom - 2,
                                    right - 6, bottom - 2 );      g.drawLine( 1, 0, right - 2, 0 );         g.drawLine( 1, 0, 1, bottom - 2 );        }
                }
                break;
            case LEFT:
                g.drawLine( 2, 6, 6, 2 );                         g.drawLine( 2, 6, 2, bottom - 1);                 g.drawLine( 6, 2, right, 2 );                     g.drawLine( right, 2, right, bottom - 1 );        g.drawLine( 2, bottom - 1,
                            right, bottom - 1 );                  break;
            case TOP:
             default:
                    if ( leftToRight ) {
                        g.drawLine( 2, 6, 6, 2 );                     g.drawLine( 2, 6, 2, bottom - 1);             g.drawLine( 6, 2, right, 2 );                 g.drawLine( right, 2, right, bottom - 1 );    g.drawLine( 2, bottom - 1,
                        ...
                        g.drawLine( right - 2, 6, right - 6, 2 );     g.drawLine( right - 2, 6,
                                    right - 2, bottom - 1);           if ( lastInRun ) {
                            g.drawLine( right - 6, 2, 2, 2 );         g.drawLine( 2, 2, 2, bottom - 1 );        g.drawLine( right - 2, bottom - 1,
                                        2, bottom - 1 );              }
                        else {
                            g.drawLine( right - 6, 2, 1, 2 );         g.drawLine( 1, 2, 1, bottom - 1 );        g.drawLine( right - 2, bottom - 1,
                                        1, bottom - 1 );              }
                    }
            }
            g.translate( -tabRect.x, -tabRect.y );
