  ...
  "inactiveCaptionBorder", theme.getControlShadow(),
    ...
    protected void initComponentDefaults(UIDefaults table) {
        ...
        Object[] defaults = {
            ...
            "AuditoryCues.playList", null, "TextField.border", textFieldBorder,
       ...
       "shift ctrl alt F6", "selectPreviousFrame",
           ...
           "shift ctrl F12", "navigatePrevious"
            ...
            "Table.gridColor", controlShadow,  "Table.ancestorInputMap",
               new UIDefaults.LazyInputMap(new Object[] {
                               "ctrl C", "copy",
                               "ctrl V", "paste",
                               "ctrl X", "cut",
            ...
            "Tree.line", primaryControl, "Tree.hash", primaryControl,  "Tree.rowHeight", zero,
            "Tree.focusInputMap",
               new UIDefaults.LazyInputMap(new Object[] {
                                    "ADD", "expand",
                               "SUBTRACT", "collapse",
        ...
        flushUnreferenced(); boolean lafCond = SwingUtilities2.isLocalDisplay();
