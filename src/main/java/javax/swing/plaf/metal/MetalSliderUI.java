...
public class MetalSliderUI extends BasicSliderUI {
    ...
    protected class MetalPropertyListener extends BasicSliderUI.PropertyChangeHandler {
        public void propertyChange( PropertyChangeEvent e ) {  super.propertyChange( e );
    ...
    public void paintTrack(Graphics g)  {
        ...
        if ( filledSlider ) {
            ...
            if ( slider.getOrientation() == JSlider.HORIZONTAL ) {
                ...
                middleOfThumb -= trackRect.x; fillTop = !slider.isEnabled() ? trackTop : trackTop + 1;
                ...
                middleOfThumb -= trackRect.y; fillLeft = !slider.isEnabled() ? trackLeft : trackLeft + 1;
                fillRight = !slider.isEnabled() ? trackRight - 1 : trackRight - 2;
