...
public void setPreferredScrollableViewportSize(Dimension size) {
    ...
    public int getScrollableUnitIncrement(Rectangle visibleRect,
        ...
        if (leadingVisibleEdge == leadingCellEdge) { if (direction < 0) {
                int retVal = 0;
            ...
            else { return leadingCellSize;
            }
        }
        else { int hiddenAmt = Math.abs(leadingVisibleEdge - leadingCellEdge);
            int visibleAmt = leadingCellSize - hiddenAmt;

            if (direction > 0) {
                return visibleAmt;
            }
            else { return hiddenAmt;
            }
        }
    }
    ...
    private int getPreviousBlockIncrement(Rectangle visibleRect,
        ...
        else { newEdge = visibleLeadingEdge + visibleRect.width;
    ...
    private int getNextBlockIncrement(Rectangle visibleRect,
        ...
        else { cellFillsVis = cellLeadingEdge >= visibleLeadingEdge;
        }
...
public AccessibleContext getAccessibleContext() {
    ...
    public void propertyChange(PropertyChangeEvent e) {
            ...
            Object newValue = e.getNewValue();
                ...
                if (source == JTable.this) {    if (oldValue != null &&
    ...
    public int getAccessibleSelectionCount() {
            ...
            if (JTable.this.cellSelectionEnabled) { return rowsSel * colsSel;
        ...
        public Accessible getAccessibleSelection(int i) {
            ...
            if (JTable.this.cellSelectionEnabled) { r = rowIndicies[i / colsSel];
                ...
                if (JTable.this.getRowSelectionAllowed() &&
                    ...
                    while (j < rowIndicies.length) {
                        ...
                        case IN_ROW:   if (curIndex < ttlCols) { c = curIndex % ttlCols;
                                r = rowIndicies[j];
                                return getAccessibleChild((r * ttlCols) + c);
                            } else {                               curIndex -= ttlCols;
                            }
                        ...
                        case NOT_IN_ROW:  if (curIndex <
                                ...
                                r = (j > 0 ? rowIndicies[j-1] + 1 : 0)
                                    + curIndex / colsSel;
                                return getAccessibleChild((r * ttlCols) + c);
                            } else {                               curIndex -= colsSel * (rowIndicies[j] -
                                (prevRow == -1 ? 0 : (prevRow + 1)));
                            }
                            state = IN_ROW;
                            break;
                    ...
                    if (curIndex <
                        (colsSel * (ttlRows -
                        (prevRow == -1 ? 0 : (prevRow + 1))))) { c = colIndicies[curIndex % colsSel];
