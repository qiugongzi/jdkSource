...
public class DefaultStyledDocument extends AbstractDocument implements StyledDocument {
    ...
    private void removeElementImpl(Element elem) {
        ...
        if (endOffset >= lastEndOffset) {
            ...
            removeTo = lastEndOffset - 1; try {
                if (content.getString(startOffset - 1, 1).charAt(0) == '\n') {
                    removeFrom--; }
            } catch (BadLocationException ble) { throw new IllegalStateException(ble);
            }
            atEnd = true;
        }
        ...
        while (parent.getElementCount() == 1) {
            ...
            if (parent == null) { throw new IllegalStateException("invalid element structure");
            }
        }
        ...
        if (atEnd) {
            ...
            if (prevLeaf == null) { throw new IllegalStateException("invalid element structure");
            }
    ...
    public class ElementBuffer implements Serializable {
        ...
        Element root;
        transient int pos;          transient int offset;
        ...
        transient boolean recreateLeafs; transient ElemChanges[] insertPath;
