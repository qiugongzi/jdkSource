...
public class JProgressBar extends JComponent implements SwingConstants, Accessible
{
    ...
    public JProgressBar(int orient, int min, int max)
    {
        ...
        setOrientation(orient);      setBorderPainted(true);      setStringPainted(false);     setString(null);             setIndeterminate(false);     }
    ...
    public JProgressBar(BoundedRangeModel newModel)
    {
        ...
        setOrientation(defaultOrientation);  setBorderPainted(true);              setStringPainted(false);             setString(null);                     setIndeterminate(false);             }
