...
public class JColorChooser extends JComponent implements Accessible {
    ...
    public static Color showDialog(Component component,
        ...
        dialog.show(); return ok.getColor();
    }
    ...
    public AbstractColorChooserPanel removeChooserPanel( AbstractColorChooserPanel panel ) {
        ...
        if (containedAt == chooserPanels.length-1) {  System.arraycopy(chooserPanels, 0, newArray, 0, newArray.length);
        }
        else if (containedAt == 0) {  System.arraycopy(chooserPanels, 1, newArray, 0, newArray.length);
        }
        else {  System.arraycopy(chooserPanels, 0, newArray, 0, containedAt);
