...
public class ProgressMonitor implements Accessible
{
    ...
    protected class AccessibleProgressMonitor extends AccessibleContext
        ...
        public int getCharCount() {
            AccessibleText at = getNoteLabelAccessibleText();
            if (at != null) {   return at.getCharCount();
            }
            return -1;
        }
        ...
        public int getCaretPosition() {
            AccessibleText at = getNoteLabelAccessibleText();
            if (at != null) {   return at.getCaretPosition();
            }
            return -1;
        }
        ...
        public String getAtIndex(int part, int index) {
            AccessibleText at = getNoteLabelAccessibleText();
            if (at != null) {   return at.getAtIndex(part, index);
            }
            return null;
        }
        ...
        public String getAfterIndex(int part, int index) {
            AccessibleText at = getNoteLabelAccessibleText();
            if (at != null) {   return at.getAfterIndex(part, index);
            }
            return null;
        }
        ...
        public String getBeforeIndex(int part, int index) {
            AccessibleText at = getNoteLabelAccessibleText();
            if (at != null) {   return at.getBeforeIndex(part, index);
            }
            return null;
        }
        ...
        public AttributeSet getCharacterAttribute(int i) {
            AccessibleText at = getNoteLabelAccessibleText();
            if (at != null) {   return at.getCharacterAttribute(i);
            }
            return null;
        }
        ...
        public int getSelectionStart() {
            AccessibleText at = getNoteLabelAccessibleText();
            if (at != null) {   return at.getSelectionStart();
            }
            return -1;
        }
        ...
        public int getSelectionEnd() {
            AccessibleText at = getNoteLabelAccessibleText();
            if (at != null) {   return at.getSelectionEnd();
            }
            return -1;
        }
        ...
        public String getSelectedText() {
            AccessibleText at = getNoteLabelAccessibleText();
            if (at != null) {   return at.getSelectedText();
            }
            return null;
        }
