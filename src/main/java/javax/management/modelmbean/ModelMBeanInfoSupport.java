...
public class ModelMBeanInfoSupport extends MBeanInfo implements ModelMBeanInfo {
    ...
    throws MBeanException, RuntimeOperationsException {
        ...
        if (inDescriptors.length == 0) { return;
        }
    ...
    throws MBeanException, RuntimeOperationsException {
        ...
        MBeanOperationInfo[] operList = modelMBeanOperations; int numOpers = 0;
        if (operList != null) numOpers = operList.length;
    ...
    throws MBeanException, RuntimeOperationsException {
        ...
        MBeanConstructorInfo[] consList = modelMBeanConstructors; int numCons = 0;
        if (consList != null) numCons = consList.length;
    ...
    throws MBeanException, RuntimeOperationsException {
        ...
        MBeanNotificationInfo[] notifList = modelMBeanNotifications; int numNotifs = 0;
        if (notifList != null) numNotifs = notifList.length;
