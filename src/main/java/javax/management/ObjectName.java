...
@SuppressWarnings("serial") public class ObjectName implements Comparable<ObjectName>, QueryExp {
    ...
    private void construct(String name)
        ...
        final char[] canonical_chars = new char[len]; int cname_index = 0;
        int index = 0;
        char c, c1;
        ...
        while (index < len) {
            ...
            value_index = in_index; key_length = value_index - key_index - 1; boolean value_pattern = false;
    ...
    public boolean equals(Object object)  {
        ...
        if (_canonicalName == on_string) return true;  return false;
   }
