...
import javax.management.DescriptorRead;  import javax.management.ImmutableDescriptor;
...
public class OpenMBeanParameterInfoSupport
    ...
    private Set<?> legalValues     = null;  private Comparable<?> minValue        = null;


    private Comparable<?> maxValue        = null;


    private transient Integer myHashCode = null;        private transient String  myToString = null;        public OpenMBeanParameterInfoSupport(String name,
                                         String description,
                                         OpenType<?> openType) {
    ...
    public OpenMBeanParameterInfoSupport(String name,
        ...
        descriptor = getDescriptor();  this.defaultValue = valueFrom(descriptor, "defaultValue", openType);
