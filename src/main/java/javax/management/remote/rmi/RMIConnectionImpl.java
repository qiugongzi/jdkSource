...
public class RMIConnectionImpl implements RMIConnection, Unreferenced {
    ...
    @SuppressWarnings("rawtypes")  public ObjectInstance createMBean(String className,
                                      ObjectName name,
    ...
    @SuppressWarnings("rawtypes")  public Set<ObjectInstance>
    ...
    @SuppressWarnings("rawtypes")  public Set<ObjectName>
    ...
    @SuppressWarnings("rawtypes")  public void setAttribute(ObjectName name,
    ...
    @SuppressWarnings("rawtypes")  public AttributeList setAttributes(ObjectName name,
    ...
    @SuppressWarnings("rawtypes")  public Object invoke(ObjectName name,
    ...
    @SuppressWarnings("rawtypes")  public Integer[] addNotificationListeners(ObjectName[] names,
    ...
    @SuppressWarnings("rawtypes")  public void addNotificationListener(ObjectName name,
                       ObjectName listener,
    ...
    @SuppressWarnings("rawtypes")  public void removeNotificationListener(ObjectName name,
                        ObjectName listener,
                        MarshalledObject filter,
                        MarshalledObject handback,
                        Subject delegationSubject)
