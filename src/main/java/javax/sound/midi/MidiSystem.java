...
public class MidiSystem {
    ...
    public static MidiFileFormat getMidiFileFormat(InputStream stream)
        ...
        for(int i = 0; i < providers.size(); i++) {
            ...
            try {
                format = reader.getMidiFileFormat( stream ); break;
    ...
    public static MidiFileFormat getMidiFileFormat(URL url)
        ...
        for(int i = 0; i < providers.size(); i++) {
            MidiFileReader reader = (MidiFileReader) providers.get(i);
            try {
                format = reader.getMidiFileFormat( url ); break;
            } catch (InvalidMidiDataException e) {
                continue;
            }
        }
    ...
    public static MidiFileFormat getMidiFileFormat(File file)
        ...
        for(int i = 0; i < providers.size(); i++) {
            MidiFileReader reader = (MidiFileReader) providers.get(i);
            try {
                format = reader.getMidiFileFormat( file ); break;
            } catch (InvalidMidiDataException e) {
                continue;
            }
        }
    ...
    public static Sequence getSequence(InputStream stream)
        ...
        for(int i = 0; i < providers.size(); i++) {
            MidiFileReader reader = (MidiFileReader) providers.get(i);
            try {
                sequence = reader.getSequence( stream ); break;
            } catch (InvalidMidiDataException e) {
                continue;
            }
        }
    ...
    public static Sequence getSequence(URL url)
        ...
        for(int i = 0; i < providers.size(); i++) {
            MidiFileReader reader = (MidiFileReader) providers.get(i);
            try {
                sequence = reader.getSequence( url ); break;
            } catch (InvalidMidiDataException e) {
                continue;
            }
        }
    ...
    public static Sequence getSequence(File file)
        ...
        for(int i = 0; i < providers.size(); i++) {
            MidiFileReader reader = (MidiFileReader) providers.get(i);
            try {
                sequence = reader.getSequence( file ); break;
            } catch (InvalidMidiDataException e) {
                continue;
            }
        }
