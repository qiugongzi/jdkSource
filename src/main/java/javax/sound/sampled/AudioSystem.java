...
public class AudioSystem {
    ...
    public static AudioFileFormat getAudioFileFormat(InputStream stream)
        ...
        for(int i = 0; i < providers.size(); i++ ) {
            ...
            try {
                format = reader.getAudioFileFormat( stream ); break;
    ...
    public static AudioFileFormat getAudioFileFormat(URL url)
        ...
        for(int i = 0; i < providers.size(); i++ ) {
            AudioFileReader reader = (AudioFileReader) providers.get(i);
            try {
                format = reader.getAudioFileFormat( url ); break;
            } catch (UnsupportedAudioFileException e) {
                continue;
            }
        }
    ...
    public static AudioFileFormat getAudioFileFormat(File file)
        ...
        for(int i = 0; i < providers.size(); i++ ) {
            AudioFileReader reader = (AudioFileReader) providers.get(i);
            try {
                format = reader.getAudioFileFormat( file ); break;
            } catch (UnsupportedAudioFileException e) {
                continue;
            }
        }
    ...
    public static AudioInputStream getAudioInputStream(InputStream stream)
        ...
        for(int i = 0; i < providers.size(); i++ ) {
            AudioFileReader reader = (AudioFileReader) providers.get(i);
            try {
                audioStream = reader.getAudioInputStream( stream ); break;
            } catch (UnsupportedAudioFileException e) {
                continue;
            }
        }
    ...
    public static AudioInputStream getAudioInputStream(URL url)
        ...
        for(int i = 0; i < providers.size(); i++ ) {
            AudioFileReader reader = (AudioFileReader) providers.get(i);
            try {
                audioStream = reader.getAudioInputStream( url ); break;
            } catch (UnsupportedAudioFileException e) {
                continue;
            }
        }
    ...
    public static AudioInputStream getAudioInputStream(File file)
        ...
        for(int i = 0; i < providers.size(); i++ ) {
            AudioFileReader reader = (AudioFileReader) providers.get(i);
            try {
                audioStream = reader.getAudioInputStream( file ); break;
            } catch (UnsupportedAudioFileException e) {
                continue;
            }
        }
    ...
    public static int write(AudioInputStream stream, AudioFileFormat.Type fileType,
        ...
        for(int i=0; i < providers.size(); i++) {
            AudioFileWriter writer = (AudioFileWriter) providers.get(i);
            try {
                bytesWritten = writer.write( stream, fileType, out ); flag = true;
                break;
            } catch (IllegalArgumentException e) {
                continue;
            }
    ...
    private static List getMixerInfoList(List providers) {
        ...
        Mixer.Info[] someInfos; Mixer.Info[] allInfos;  for(int i = 0; i < providers.size(); i++ ) {
