...
public abstract class BaseRowSet implements Serializable, Cloneable {
    ...
    private boolean showDeleted = false; private int queryTimeout = 0; private int maxRows = 0; private int maxFieldSize = 0; private int concurrency = ResultSet.CONCUR_UPDATABLE;
    ...
    private int fetchDir = ResultSet.FETCH_FORWARD; private int fetchSize = 0; private Map<String, Class<?>> map;


    private Vector<RowSetListener> listeners;


    private Hashtable<Integer, Object> params; public BaseRowSet() {
