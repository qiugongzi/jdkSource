...
public class SyncFactory {
    ...
    public static SyncProvider getInstance(String providerID)
        ...
        initMapIfNecessary(); initJNDIContext();    ProviderImpl impl = (ProviderImpl) implementations.get(providerID);
    ...
    private static synchronized void initJNDIContext() throws SyncFactoryException {
        ...
        if ((ic != null) && (lazyJNDICtxRefresh == false)) {
            try {
                ...
                lazyJNDICtxRefresh = true; } catch (NamingException e) {
                e.printStackTrace();
    ...
    private static void enumerateBindings(NamingEnumeration<?> bindings,
        ...
        boolean syncProviderObj = false; try {
            Binding bd = null;
